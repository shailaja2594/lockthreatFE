...
function DataView_div_2_Template(rf, ctx) { if (rf & 1) {
    ...
    ɵngcc0.ɵɵadvance(1);
    ɵngcc0.ɵɵclassMap("ui-dataview-loading-icon pi-spin " + ctx_r235.loadingIcon);
} }
function DataView_p_paginator_5_Template(rf, ctx) { if (rf & 1) {
    ...
    ɵngcc0.ɵɵlistener("onPageChange", function DataView_p_paginator_5_Template_p_paginator_onPageChange_0_listener($event) { ɵngcc0.ɵɵrestoreView(_r242); var ctx_r241 = ɵngcc0.ɵɵnextContext(); return ctx_r241.paginate($event); });
    ɵngcc0.ɵɵelementEnd();
} if (rf & 2) {
    var ctx_r236 = ɵngcc0.ɵɵnextContext();
    ɵngcc0.ɵɵproperty("rows", ctx_r236.rows)("first", ctx_r236.first)("totalRecords", ctx_r236.totalRecords)("pageLinkSize", ctx_r236.pageLinks)("alwaysShow", ctx_r236.alwaysShowPaginator)("rowsPerPageOptions", ctx_r236.rowsPerPageOptions)("dropdownAppendTo", ctx_r236.paginatorDropdownAppendTo)("dropdownScrollHeight", ctx_r236.paginatorDropdownScrollHeight)("templateLeft", ctx_r236.paginatorLeftTemplate)("templateRight", ctx_r236.paginatorRightTemplate)("currentPageReportTemplate", ctx_r236.currentPageReportTemplate)("showCurrentPageReport", ctx_r236.showCurrentPageReport);
} }
...
function DataView_ng_template_8_Template(rf, ctx) { if (rf & 1) {
    ...
    var rowData_r243 = ctx.$implicit;
    var rowIndex_r244 = ctx.index;
    var ctx_r237 = ɵngcc0.ɵɵnextContext();
    ɵngcc0.ɵɵproperty("ngTemplateOutlet", ctx_r237.itemTemplate)("ngTemplateOutletContext", ɵngcc0.ɵɵpureFunction2(2, _c0, rowData_r243, rowIndex_r244));
} }
function DataView_div_10_Template(rf, ctx) { if (rf & 1) {
    ...
    ɵngcc0.ɵɵadvance(1);
    ɵngcc0.ɵɵtextInterpolate(ctx_r238.emptyMessage);
} }
function DataView_p_paginator_11_Template(rf, ctx) { if (rf & 1) {
    ...
    ɵngcc0.ɵɵlistener("onPageChange", function DataView_p_paginator_11_Template_p_paginator_onPageChange_0_listener($event) { ɵngcc0.ɵɵrestoreView(_r247); var ctx_r246 = ɵngcc0.ɵɵnextContext(); return ctx_r246.paginate($event); });
    ɵngcc0.ɵɵelementEnd();
} if (rf & 2) {
    var ctx_r239 = ɵngcc0.ɵɵnextContext();
    ɵngcc0.ɵɵproperty("rows", ctx_r239.rows)("first", ctx_r239.first)("totalRecords", ctx_r239.totalRecords)("pageLinkSize", ctx_r239.pageLinks)("alwaysShow", ctx_r239.alwaysShowPaginator)("rowsPerPageOptions", ctx_r239.rowsPerPageOptions)("dropdownAppendTo", ctx_r239.paginatorDropdownAppendTo)("dropdownScrollHeight", ctx_r239.paginatorDropdownScrollHeight)("templateLeft", ctx_r239.paginatorLeftTemplate)("templateRight", ctx_r239.paginatorRightTemplate)("currentPageReportTemplate", ctx_r239.currentPageReportTemplate)("showCurrentPageReport", ctx_r239.showCurrentPageReport);
} }
