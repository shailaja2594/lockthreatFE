...
function ToastItem_a_3_Template(rf, ctx) { if (rf & 1) {
    ...
    ɵngcc0.ɵɵlistener("click", function ToastItem_a_3_Template_a_click_0_listener($event) { ɵngcc0.ɵɵrestoreView(_r134); var ctx_r133 = ɵngcc0.ɵɵnextContext(); return ctx_r133.onCloseIconClick($event); })("keydown.enter", function ToastItem_a_3_Template_a_keydown_enter_0_listener($event) { ɵngcc0.ɵɵrestoreView(_r134); var ctx_r135 = ɵngcc0.ɵɵnextContext(); return ctx_r135.onCloseIconClick($event); });
    ɵngcc0.ɵɵelementEnd();
} }
...
function ToastItem_ng_container_4_Template(rf, ctx) { if (rf & 1) {
    ...
    ɵngcc0.ɵɵadvance(1);
    ɵngcc0.ɵɵproperty("ngClass", ɵngcc0.ɵɵpureFunction4(3, _c1, ctx_r131.message.severity == "info", ctx_r131.message.severity == "warn", ctx_r131.message.severity == "error", ctx_r131.message.severity == "success"));
    ɵngcc0.ɵɵadvance(3);
    ɵngcc0.ɵɵtextInterpolate(ctx_r131.message.summary);
    ɵngcc0.ɵɵadvance(2);
    ɵngcc0.ɵɵtextInterpolate(ctx_r131.message.detail);
} }
...
function Toast_p_toastItem_2_Template(rf, ctx) { if (rf & 1) {
    ...
    ɵngcc0.ɵɵlistener("onClose", function Toast_p_toastItem_2_Template_p_toastItem_onClose_0_listener($event) { ɵngcc0.ɵɵrestoreView(_r141); var ctx_r140 = ɵngcc0.ɵɵnextContext(); return ctx_r140.onMessageClose($event); })("@toastAnimation.start", function Toast_p_toastItem_2_Template_p_toastItem_animation_toastAnimation_start_0_listener($event) { ɵngcc0.ɵɵrestoreView(_r141); var ctx_r142 = ɵngcc0.ɵɵnextContext(); return ctx_r142.onAnimationStart($event); });
    ɵngcc0.ɵɵelementEnd();
} if (rf & 2) {
    var msg_r138 = ctx.$implicit;
    var i_r139 = ctx.index;
    var ctx_r137 = ɵngcc0.ɵɵnextContext();
    ɵngcc0.ɵɵproperty("message", msg_r138)("index", i_r139)("template", ctx_r137.template)("@toastAnimation", undefined)("showTransformOptions", ctx_r137.showTransformOptions)("hideTransformOptions", ctx_r137.hideTransformOptions)("showTransitionOptions", ctx_r137.showTransitionOptions)("hideTransitionOptions", ctx_r137.hideTransitionOptions);
} }
