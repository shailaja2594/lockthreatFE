(function (global, factory) {
    typeof exports === 'object' && typeof module !== 'undefined' ? factory(exports, require('lodash/cloneDeep'), require('@angular/platform-browser'), require('@angular/core'), require('@angular/common'), require('ngx-bootstrap/popover')) :
    typeof define === 'function' && define.amd ? define('angular-calendar-year-view', ['exports', 'lodash/cloneDeep', '@angular/platform-browser', '@angular/core', '@angular/common', 'ngx-bootstrap/popover'], factory) :
    (factory((global['angular-calendar-year-view'] = {}),global.cloneDeep,global.ng.platformBrowser,global.ng.core,global.ng.common,global.popover));
}(this, (function (exports,cloneDeep,platformBrowser,i0,common,popover) { 'use strict';

    var cloneDeep__default = 'default' in cloneDeep ? cloneDeep['default'] : cloneDeep;
    ...
    var AngularCalendarYearViewService = /** @class */ (function () {
        ...
        /** @nocollapse */ AngularCalendarYearViewService.ngInjectableDef = i0.defineInjectable({ factory: function AngularCalendarYearViewService_Factory() { return new AngularCalendarYearViewService(); }, token: AngularCalendarYearViewService, providedIn: "root" });
    ...
    var AngularCalendarYearViewComponent = /** @class */ (function () {
        ...
        /** @nocollapse */
        AngularCalendarYearViewComponent.ctorParameters = function () {
            return [
        ...
        AngularCalendarYearViewComponent.propDecorators = {
            ...
            nothingToshowText: [{ type: i0.Input }],
            popoverEnabled: [{ type: i0.Input }],
    ...
    exports.AngularCalendarYearViewService = AngularCalendarYearViewService;
    exports.AngularCalendarYearViewComponent = AngularCalendarYearViewComponent;
    exports.AngularCalendarYearViewModule = AngularCalendarYearViewModule;

    Object.defineProperty(exports, '__esModule', { value: true });

})));

//# sourceMappingURL=angular-calendar-year-view.umd.js.map