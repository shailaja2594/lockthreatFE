...
<script type="text/html" id="dxrdp-surface-mobile-bottom">
    <div class="dxrdp-mobile-actions" data-bind="visible: visible">
        <div class="dxrdp-mobile-actions-content">
            <!-- ko foreach: actions -->
            <div class="dxrdp-mobile-action" data-bind="visible: visible, css: $data.imageClassName, template: { name: $data.imageTemplateName, if: !!ko.unwrap($data.imageTemplateName)}, dxAction: clickAction"> </div>
            <!-- ko if: $data.content -->
...
<script type="text/html" id="dxrd-multivalue">
    <!-- ko with: value -->
    <div data-bind="dxTagBox: $parent.getOptions({ dataSource: dataSource, searchEnabled: true, searchExpr: ['displayValue'], value: value, 
         displayExpr: $data.displayExpr || 'displayValue', valueExpr: 'value', multiline: false, showSelectionControls: true, 
         showDropDownButton: !!$data.showDropDownButton, selectAllMode: 'allPages', selectedItems: $data.selectedItems, 
         placeholder: $root.dx.Analytics.Localization.selectPlaceholder(), maxDisplayedTags: $data.maxDisplayedTags }), dxValidator: { validationRules: $parent.validationRules || [] }">
    </div>
    <!-- /ko -->
</script>
...
<script type="text/html" id="dx-chart-leftPanel">
    <div class="dx-chart-left-panel dxd-border-primary dxd-properties-panel-group-header-back-color">
...
<script type="text/html" id="dxcd-field">
    <div data-bind="dxFieldListPicker: { path: path, acceptCustomValue: true, value: value, itemsProvider: $root.dataBindingsProvider(), treeListController: treeListController, disabled: disabled }"></div>
</script>
...
<script type="text/html" id="dxcd-viewHeader">
    <div data-bind="dxSelectBox: { dataSource: values, itemTemplate: 'stateItem', valueExpr: 'value', value: generateHeaderValue($root.undoEngine), displayExpr: 'displayValue', disabled: disabled }">
        <div class="lookupItem" data-options="dxTemplate:{ name:'stateItem' }">
            <div style="display:inline-block; width: 24px; height: 24px;" data-bind="css: $parent.generateViewClassName(value), template: {name: $parent.generateViewClassName(value, true), if: !!$parent.generateViewClassName(value, true)}"> </div>
...
<script type="text/html" id="dxrd-band-coordinate-grid">
    ...
    <div data-bind="styleunit: { 'height': height, top: absolutePosition.y }" class="dxrd-band-collapsed">
        <div data-bind="css: { 'dxrd-band-content-selected': selected() }" style="position:absolute; height: 100%; width: 100%"></div>
    </div>
    <!-- /ko -->
    <!-- /ko -->
</script>
...
<script type="text/html" id="dxrd-vertical-bands-container-vruler">
    ...
    resizable: { starting: function() {
        ...
        $data.stopResize(); $root.resizeHandler.stopped(); $root.resizeHandler.started = false;
    }, handles: 's', forceResize: resize, zoom: $root.surface().zoom, minimumHeight: minHeight || 1 }">
            <div data-bind="ruler: { 'zoom': zoom, 'length': height, 'units': $parent.measureUnit, 'direction': 'vertical', flip: $root.dx['config']()['rtlEnabled'] }"></div>
        </div>
...
<div data-bind="style: { cssFloat: isGlyphAlignmentNear() ? 'left': 'right', width: checkStateWidth() }, styleunit: { lineHeight: contentHeightWithoutZoom }" style="text-align:center ">
...
<div class="dxrd-surface" data-bind="styleunit: { 'width': Math.min(pageWidth() + maxMarkerWidth(), $root.surfaceSize()) }, css: { 'dxrd-surface-rtl': rtl() }, click: function(surface, e) { $root.selection.clickHandler($root.selection.dropTarget ? null : surface, e); e.stopPropagation(); }, keyDownActions: $root.actionLists">
    <div class="dxrd-content-panel-wrapper" data-bind="styleunit: $root.dx['config']()['rtlEnabled'] ?  { right: maxMarkerWidth() } : { left: maxMarkerWidth() }">
...
<!-- ko if: $data.reportSurface.watermark.image() -->
<div data-bind="css: {'dxrd-flip': forLeftMargin }, dxWatermark: { band: band, reportSurface: reportSurface, forLeftMargin: forLeftMargin, image: 'data:image/png;base64,' + reportSurface.watermark.image(), transparency: reportSurface.watermark.imageTransparency(), viewMode: reportSurface.watermark.imageViewMode(), align: reportSurface.watermark.imageAlign(), tiling: reportSurface.watermark.imageTiling() }" style="position: absolute"></div>
<!-- /ko -->
<!-- ko if: $data.reportSurface.watermark.text() -->
<div data-bind="css: {'dxrd-flip': forLeftMargin }, dxWatermark: { band: band, reportSurface: reportSurface, forLeftMargin: forLeftMargin, image: reportSurface._watermarkTextRenderingResult(), transparency: reportSurface.watermark.textTransparency(), viewMode: 'Stretch', align: 'MiddleCenter', tiling: false }" style="position: absolute"></div>
<!-- /ko --></script>
...
<script type="text/html" id="dxrd-reportSourceUrl">
    <div data-bind="dxSelectBox: { items: getItems($root.reportUrls, $root.navigateByReports.currentTab), value: value, disabled: disabled, valueExpr: 'Key', displayExpr: 'Value' }"></div>
</script>
...
<script type="text/html" id="dxrd-datasource">
    <div data-bind="dxSelectBox: getEditorOptions($root.dataSourceHelper, $root.undoEngine)"></div>
</script>
...
<script type="text/html" id="dxrd-reportexplorer-editor">
    <div data-bind="dxFieldListPicker: { value: itemsProvider.selectedPath, acceptCustomValue: true, displayValue: displayExpr, itemsProvider: itemsProvider, path: itemsProvider.path, disabled: disabled, treeListController: treeListController }"></div>
</script>
...
<script type="text/html" id="dxrd-image-loadfile">
    <div data-bind="dxImageSourceEditor: { value: value, placeHolder: 'Image', accept: 'image/*', type: 'img', disabled: disabled }"></div>
</script>

<script type='text/html' id='dxrd-page-colorScheme'>
<div class="dxrd-wizard-page dxrd-page-color-scheme">
    <!-- ko foreach: lookupData.scheme -->
    <div class="dxrd-page-color-scheme-tile" data-bind="click: function () { $parent.applyScheme($data); }, style: { backgroundColor: color }">
...
<div class="dxrd-wizard-page dxrd-wizard-masterdetail-groups-page">
    ...
    <div class="dxrd-wizard-left-panel">
        ...
        <div class="dx-default-border-style dxd-border-secondary">
            <div class="dxrd-wizard-list" data-bind="dxList: { items: currentFields().items, selectedItems: currentFields().activeItemArray, height: 288, selectionMode: 'single', activeStateEnabled: false, onItemClick: fieldClick, noDataText: $root.dx.Analytics.Localization.noDataText() }">
                <div data-options="dxTemplate : { name: 'item' }" data-bind="event: { dblclick: $parent.fieldDblClick }">
                    <div data-bind="text: $data"></div>
                </div>
            </div>
    ...
    <div class="dxrd-wizard-splitter">
        ...
        <div class="dxrd-wizard-splitter-action" data-bind="dxButtonWithTemplate: { onClick: appendFieldsToGroup, disabled: !isAppendToGroupEnabled(), icon: 'dxrd-svg-operations-add', iconClass: 'dxrd-image-add' }"></div>
        <div class="dxrd-wizard-splitter-action" data-bind="dxButtonWithTemplate: { onClick: removeGroup, disabled: !isRemoveGroupEnabled(), icon: 'dxrd-svg-operations-moveleft', iconClass: 'dxrd-image-moveleft' }"></div>
        <div class="dxrd-wizard-splitter-action" style="margin-top: 83px;" data-bind="dxButtonWithTemplate: { onClick: moveUp, disabled: !isMoveUpEnabled(), icon: 'dxrd-svg-operations-moveup', iconClass: 'dxrd-image-moveup' }"></div>
        <div class="dxrd-wizard-splitter-action" data-bind="dxButtonWithTemplate: { onClick: moveDown, disabled: !isMoveDownEnabled(), icon: 'dxrd-svg-operations-movedown', iconClass: 'dxrd-image-movedown' }"></div>
    </div>
    <div class="dxrd-wizard-right-panel">
        <div class="dxrd-wizard-list-title" data-bind="text: groupCaption"></div>
        <div class="dx-default-border-style dxd-border-secondary">
            <div class="dxrd-wizard-list" data-bind="dxList: { items: currentGroups().items, height: 288, selectionMode: 'single', selectedItems: currentGroups().activeItemArray, activeStateEnabled: false, onItemClick: groupClick, noDataText: $root.dx.Analytics.Localization.noDataText() }">
                <div data-options="dxTemplate : { name: 'item' }" data-bind="event: { dblclick: $parent.groupDblClick }">
                    <div data-bind="text: fields().join(', ')"></div>
                </div>
            </div>
...
<div class="dxrd-wizard-page dxrd-wizard-masterdetail-select-reportdata-page">
    <div class="dxrd-wizard-reportdata-title dx-first-column" data-bind="text: selectDataMembersCaption"></div>
    <div class="dxrd-wizard-reportdata-title" data-bind="text: selectDataFieldsCaption"></div>
    <div class="dxrd-wizard-add-queries-page dxrd-wizard-masterdetail-dataMember dx-first-column dxd-border-secondary" data-bind="dxScrollView: { showScrollbar: 'onHover', height: 361 }">
        <div data-bind="treelist: dataMemberFieldListModel" style="width:100%; height: 100%;"></div>
    </div>
    <div class="dxrd-wizard-add-queries-page dxrd-wizard-masterdetail-fields dxd-border-secondary" data-bind="dxScrollView: { showScrollbar: 'onHover', height: 361 }">
...
<div class="dxrd-wizard-page dxrd-wizard-masterdetail-summary-options-page">
    ...
    <div class="dxrd-wizard-list dx-default-border-style dxd-border-secondary" data-bind="dxScrollView: { showScrollbar: 'onHover', height: 254 }">
        <div class="dxrd-wizard-summary-infos dxrd-wizard-summary-infos-paragraf dxd-border-secondary">
            <div class="dxrd-wizard-summary-infos-container dxd-wizard-title-back-color dxd-back-secondary dxd-border-secondary" data-bind="text: fieldsCaprion"></div>
            <div class="dxrd-wizard-summary-infos-container dxd-wizard-title-back-color dxd-back-secondary dxd-border-secondary" data-bind="text: summaryFunctionCaption"></div>
        ...
        <div data-bind="foreach: summaryInfos">
            <div class="dxrd-wizard-summary-infos dxd-border-secondary">
                <div class="dxrd-wizard-summary-infos-container dxd-wizard-title-back-color dxd-back-secondary dxd-border-secondary">
...
<div class="dxrd-wizard-page dxrd-page-setup-page">
    <div class="dxrd-wizard-preview dxd-back-secondary">
        <div class="dxrd-wizard-preview-page" data-bind="styleunit: { width: previewPageWidth, height: previewPageHeight }">
    ...
    <div class="dxrd-page-setup-content">
        <div class="dxrd-page-setup-group">
            ...
            <div class="dx-fieldset dxrd-page-setup-long-group">
                <div class="dx-field">
                    <div class="dx-field-label dxd-text-primary" data-bind="text: $root.getLocalization('Size:', 'ASPxReportsStringId.ReportDesigner_Wizard_PageSetup_Size')"></div>
                    <div class="dx-field-value" data-bind="dxSelectBox: { items: lookupData.paperKind, valueExpr: 'value', displayExpr: 'displayName', value: paperKind }"></div>
                </div>
            </div>
            <div class="dxrd-page-setup-setting">
                <div class="dx-fieldset dxrd-group-fieldset">
                    <div class="dx-field">
                        <div class="dx-field-label dxd-text-primary" data-bind="text: $root.getLocalization('Unit:', 'ASPxReportsStringId.ReportDesigner_Wizard_PageSetup_Unit')"></div>
                        <div class="dx-field-value" data-bind="dxSelectBox: { items: lookupData.unit, valueExpr: 'value', displayExpr: 'displayName', value: unit }"></div>
                    </div>
                    <div class="dx-field">
                        <div class="dx-field-label dxd-text-primary" data-bind="text: $root.getLocalization('Width:', 'ASPxReportsStringId.ReportDesigner_Wizard_Width')"></div>
                        <div class="dx-field-value" data-bind="dxNumberBox: { value: width, disabled: fixedSize, format: valueFormat, min: 0 }"></div>
                    </div>
                    <div class="dx-field">
                        <div class="dx-field-label dxd-text-primary" data-bind="text: $root.getLocalization('Height:', 'ASPxReportsStringId.ReportDesigner_Wizard_Height')"></div>
        ...
        <div class="dxrd-page-setup-group" style="margin-top: 16px;">
            ...
            <div class="dxrd-page-setup-setting">
                <div class="dx-fieldset dxrd-group-fieldset">
                    <div class="dx-field">
                        <div class="dx-field-label dxd-text-primary" data-bind="text: $root.getLocalization('Left:', 'ASPxReportsStringId.ReportDesigner_Wizard_PageSetup_LeftMargin')"></div>
                        <div class="dx-field-value" data-bind="dxNumberBox: { value: marginLeft, format: valueFormat, min: 0 }"></div>
                    </div>
                    <div class="dx-field">
                        <div class="dx-field-label dxd-text-primary" data-bind="text: $root.getLocalization('Top:', 'ASPxReportsStringId.ReportDesigner_Wizard_PageSetup_TopMargin')"></div>
                        <div class="dx-field-value" data-bind="dxNumberBox: { value: marginTop, format: valueFormat, min: 0 }"></div>
                    </div>
                </div>
                <div class="dx-fieldset dxrd-group-fieldset" style="float:right">
                    <div class="dx-field">
                        <div class="dx-field-label dxd-text-primary" data-bind="text: $root.getLocalization('Right:', 'ASPxReportsStringId.ReportDesigner_Wizard_PageSetup_RightMargin')"></div>
                        <div class="dx-field-value" data-bind="dxNumberBox: { value: marginRight, format: valueFormat, min: 0 }"></div>
                    </div>
                    <div class="dx-field">
                        <div class="dx-field-label dxd-text-primary" data-bind="text: $root.getLocalization('Bottom:', 'ASPxReportsStringId.ReportDesigner_Wizard_PageSetup_BottomMargin')"></div>
                        <div class="dx-field-value" data-bind="dxNumberBox: { value: marginBottom, format: valueFormat, min: 0 }"></div>
                    </div>
                </div>
            </div>
        </div>
...
<div class="dxrd-report-type-page">
    ...
    <div class="dx-background-inheritor dxd-back-highlighted dxd-state-selected">
        <div class="dxrd-report-type-item dx-fontsize-reestablished dxrd-report-type-item-border-color dxd-list-item-back-color" data-bind="event: { click: $parent.itemClick }, css: { 'dxd-state-selected dxd-border-secondary dxd-back-secondary': $parent.IsSelected($data) }">
