            ...
            Preview.editorTemplates = {
                multiValue: {
                    header: "dxrd-multivalue", extendedOptions: {
                        placeholder: ko.observable(DevExpress.Analytics.Localization.selectPlaceholder()),
        ...
        (function (Preview) {
            ...
            var ReportPreview = (function (_super) {
                ...
                function ReportPreview(handlerUri, previewRequestWrapper, previewHandlersHelper, callbacks, rtl) {
                    ...
                    _this_1.progressBar = new Preview.ProgressViewModel();
                    ...
                    _this_1.autoFitBy = ko.observable(Preview.ZoomAutoBy.WholePage);
                    ...
                    _this_1.zoom = ko.pureComputed({
                        read: function () {
                            ...
                            if (autoFitBy != Preview.ZoomAutoBy.None || _this_1._zoom() === 0) {
                                return autoFitBy;
                            }
                        ...
                        write: function (val) {
                            if (val > 0) {
                                _this_1.autoFitBy(Preview.ZoomAutoBy.None);
                                _this_1._zoom(val);
                            }
                            else {
                    ...
                    _this_1.previewHandlersHelper = previewHandlersHelper || new Preview.PreviewHandlersHelper(_this_1);
                    _this_1.requestWrapper = previewRequestWrapper || new Preview.PreviewRequestWrapper(null, callbacks);
                    ...
                    _this_1.documentBuilding.subscribe(function (newVal) {
                        if (!newVal) {
                            _this_1._unifier(Preview.generateGuid());
                    ...
                    _this_1._disposables.push(_this_1._currentDocumentId.subscribe(function (newVal) {
                        _this_1._unifier(newVal ? Preview.generateGuid() : '');
                    }));
                ...
                ReportPreview.prototype.initialize = function (initializeDataPromise) {
                    ...
                    initializeDataPromise.done(function (previewInitialize) {
                        if (previewInitialize && !previewInitialize.error && (previewInitialize.reportId || previewInitialize.documentId)) {
                            ...
                            var deserializedExportOptions = _this_1._deserializeExportOptions(previewInitialize.exportOptions);
                            ...
                            _this_1._processError(DevExpress.Designer.getLocalization("The report preview initialization has failed", "ASPxReportsStringId.WebDocumentViewer_InitializationErro"), previewInitialize && previewInitialize.error);
                        }
                    }).fail(function (error) {
                ...
                ReportPreview.prototype.getBuildStatus = function (documentId) {
                    ...
                    setTimeout(function () {
                        ...
                        _this_1.requestWrapper.getBuildStatusRequest(documentId, ignorePredicate)
                            .done(function (response) { _this_1.previewHandlersHelper.doneGetBuildStatusHandler(deffered, documentId, response, ignorePredicate); })
                            .fail(function (error) { _this_1.previewHandlersHelper.errorGetBuildStatusHandler(deffered, error, ignorePredicate); });
                    }, 250);
                    return deffered.promise();
                };
                ...
                ReportPreview.prototype.goToPage = function (pageIndex, forcePageChanging, throttle) {
                    ...
                    if (throttle)
                        this._goToPageTimer = setTimeout(function () { return updateActivePage(_this_1.pageIndex()); }, throttle);
                    else
