            ...
            editing: {
                ...
                _getInvisibleColumns: function(changes) {
                    ...
                    if (this.isCellOrBatchEditMode()) {
                        hasInvisibleRows = changes.some(function(change) {
                            var rowIndex = _this5._dataController.getRowIndexByKey(change.key);
                            return rowIndex < 0
                        })
                    }
                ...
                _createInvisibleColumnValidators: function(changes) {
                    ...
                    var validatingController = this.getController("validating");
                    var columnsController = this.getController("columns");
                    var invisibleColumns = this._getInvisibleColumns(changes).filter(function(column) {
