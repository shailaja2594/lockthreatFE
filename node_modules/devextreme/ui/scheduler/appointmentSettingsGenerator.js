...
var AppointmentSettingsGeneratorBaseStrategy = function() {
    ...
    _createClass(AppointmentSettingsGeneratorBaseStrategy, [{
        ...
        value: function(date, dateRangeOffset) {
        ...
        value: function(rawAppointment, groupIndex) {
            var dateRange = this._getGroupDateRange(rawAppointment, groupIndex);
        ...
        value: function(appointments, rawAppointment) {
            var _this4 = this;
            appointments.forEach(function(appointment) {
                var startDate = new Date(appointment.startDate);
                var firstViewDate = _this4._getAppointmentFirstViewDate(appointment, rawAppointment);
        ...
        value: function(gridAppointments, appointmentResources, allDay) {
            var _this5 = this;
            var result = [];
...
var AppointmentSettingsGeneratorVirtualStrategy = function(_AppointmentSettingsG) {
    ...
    _createClass(AppointmentSettingsGeneratorVirtualStrategy, [{
        ...
        value: function(appointment, resources) {
            ...
            var result = [];
            var workspace = this.scheduler._workSpace;
            var groupIndices = workspace._isVerticalGroupedWorkSpace() && workspace._getGroupCount() ? this._getGroupIndices(resources) : [0];
        ...
        value: function(rawAppointment, groupIndex) {
            if (this.scheduler.appointmentTakesAllDay(rawAppointment)) {
                return _get(_getPrototypeOf(AppointmentSettingsGeneratorVirtualStrategy.prototype), "_getGroupDateRange", this).call(this, rawAppointment, groupIndex)
            }
        ...
        value: function(appointments, itemResources) {
            ...
            var groupIndices = workspace._isVerticalGroupedWorkSpace() ? this._getGroupIndices(itemResources) : [0];
            groupIndices.forEach(function(groupIndex) {
                appointments.forEach(function(appointment) {
        ...
        value: function(resources) {
            ...
            var _this$scheduler$getWo3 = this.scheduler.getWorkSpace(),
                viewDataProvider = _this$scheduler$getWo3.viewDataProvider;
