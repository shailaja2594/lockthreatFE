...
var Scheduler = function(_Widget) {
    ...
    _createClass(Scheduler, [{
        ...
        value: function() {
            ...
            this._waitAsyncTemplate(function() {
                (0, _visibility_change.triggerResizeEvent)(_this8._workSpace.$element());
                _this8._workSpace._refreshDateTimeIndication()
            })
        }
    }, {
        key: "_workSpaceConfig",
        value: function(groups, countConfig) {
            var _currentViewOptions$s, _this9 = this;
            var currentViewOptions = this._getCurrentViewOptions();
            ...
            var result = (0, _extend.extend)({
                ...
                onSelectionChanged: function(args) {
                    _this9.option("selectedCellData", args.selectedCellData)
                },
        ...
        value: function(groups) {
            ...
            if (this._readyToRenderAppointments) {
                ...
                this._waitAsyncTemplate(function() {
                    return _this10._workSpaceRecalculation.resolve()
                })
            }
        }
    }, {
        ...
        value: function(rawAppointment, rawTargetedAppointment, exceptionDate, isDeleted, isPopupEditing, dragEvent) {
            ...
            if (isPopupEditing) {
                ...
                this._updateAppointment(rawAppointment, updatedAppointment.source(), function() {
                    _this11._appointments.moveAppointmentBack(dragEvent)
                }, dragEvent)
            }
        }
    }, {
        ...
        value: function(actionOptions, callback) {
            ...
            if ((0, _type.isPromise)(actionOptions.cancel)) {
                (0, _deferred.when)((0, _deferred.fromPromise)(actionOptions.cancel)).always(function(cancel) {
                    ...
                    resolveCallback(callback.call(_this12, cancel))
                })
            } else {
        ...
        value: function(rawAppointment, createNewAppointment, rawTargetedAppointment) {
            ...
            this._checkRecurringAppointment(rawAppointment, newTargetedAppointment, appointment.startDate, function() {
                if (createNewAppointment || (0, _type.isEmptyObject)(rawAppointment)) {
                    delete _this13._editAppointmentData;
                    _this13._editing.allowAdding && _this13._appointmentPopup.show(rawAppointment, true)
                } else {
                    _this13._editAppointmentData = rawAppointment;
                    _this13._appointmentPopup.show(rawAppointment, _this13._editing.allowUpdating)
                }
            }, false, true)
        }
    }, {
        ...
        value: function(appointment) {
            ...
            return this._processActionResult(addingOptions, function(canceled) {
                ...
                _this14._expandAllDayPanel(serializedAppointment);
                return _this14._appointmentModel.add(serializedAppointment).always(function(e) {
                    return _this14._executeActionWhenOperationIsCompleted(_this14._actions.onAppointmentAdded, serializedAppointment, e)
                })
            })
        }
    }, {
        ...
        value: function(rawAppointment) {
            ...
            var options = {
                getField: function(rawAppointment, property) {
                    return _this15.fire("getField", property, rawAppointment)
                },
                setField: function(rawAppointment, property, value) {
                    return _this15.fire("setField", property, rawAppointment, value)
                },
                getTimeZoneCalculator: function() {
                    return _this15.timeZoneCalculator
                }
            };
