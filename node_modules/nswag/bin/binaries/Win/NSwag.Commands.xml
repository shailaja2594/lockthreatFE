...
<doc>
    ...
    <members>
        ...
        <member name="T:NSwag.Commands.Generation.AspNetCore.AspNetCoreToSwaggerCommand">
            <summary>The generator.</summary>
        </member>
        ...
        <member name="T:NSwag.Commands.Generation.OpenApiGeneratorCommandBase`1">
            <inheritdoc />
        </member>
        <member name="M:NSwag.Commands.Generation.OpenApiGeneratorCommandBase`1.#ctor">
            <summary>Initializes a new instance of the <see cref="T:NSwag.Commands.Generation.OpenApiGeneratorCommandBase`1"/> class.</summary>
        </member>
        <member name="T:NSwag.Commands.Generation.TypesToOpenApiCommand">
            <summary></summary>
        </member>
        <member name="T:NSwag.Commands.Generation.TypesToSwaggerCommand">
            <summary></summary>
        </member>
        <member name="M:NSwag.Commands.Generation.TypesToSwaggerCommand.#ctor">
            <summary>Initializes a new instance of the <see cref="T:NSwag.Commands.Generation.TypesToSwaggerCommand"/> class.</summary>
        </member>
        <member name="T:NSwag.Commands.Generation.WebApi.WebApiToOpenApiCommand">
            <summary>The generator.</summary>
        </member>
        <member name="T:NSwag.Commands.Generation.WebApi.WebApiToSwaggerCommand">
            <summary>The generator.</summary>
        </member>
        <member name="M:NSwag.Commands.Generation.WebApi.WebApiToSwaggerCommand.#ctor">
            <summary>Initializes a new instance of the <see cref="T:NSwag.Commands.Generation.WebApi.WebApiToSwaggerCommand"/> class.</summary>
        </member>
        ...
        <member name="P:NSwag.Commands.OpenApiGeneratorCollection.WebApiToOpenApiCommand">
        ...
        <member name="P:NSwag.Commands.OpenApiGeneratorCollection.TypesToOpenApiCommand">
        ...
        <member name="F:NSwag.Commands.Runtime.NetCore30">
            <summary>.NET Core 3.0 app.</summary>
        </member>
        <member name="F:NSwag.Commands.Runtime.NetCore31">
