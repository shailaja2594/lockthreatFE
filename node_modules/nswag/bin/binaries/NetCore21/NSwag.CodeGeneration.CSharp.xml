...
<doc>
    ...
    <members>
        <member name="T:NSwag.CodeGeneration.CSharp.CSharpClientGenerator">
            <summary>Generates the CSharp service client code. </summary>
        </member>
        <member name="M:NSwag.CodeGeneration.CSharp.CSharpClientGenerator.#ctor(NSwag.OpenApiDocument,NSwag.CodeGeneration.CSharp.CSharpClientGeneratorSettings)">
            <summary>Initializes a new instance of the <see cref="T:NSwag.CodeGeneration.CSharp.CSharpClientGenerator" /> class.</summary>
            <param name="document">The Swagger document.</param>
            <param name="settings">The settings.</param>
            <exception cref="T:System.ArgumentNullException"><paramref name="document" /> is <see langword="null" />.</exception>
        </member>
        <member name="M:NSwag.CodeGeneration.CSharp.CSharpClientGenerator.#ctor(NSwag.OpenApiDocument,NSwag.CodeGeneration.CSharp.CSharpClientGeneratorSettings,NJsonSchema.CodeGeneration.CSharp.CSharpTypeResolver)">
            <summary>Initializes a new instance of the <see cref="T:NSwag.CodeGeneration.CSharp.CSharpClientGenerator" /> class.</summary>
            <param name="document">The Swagger document.</param>
            <param name="settings">The settings.</param>
        ...
        <member name="P:NSwag.CodeGeneration.CSharp.CSharpClientGenerator.Settings">
            <summary>Gets or sets the generator settings.</summary>
        </member>
        <member name="P:NSwag.CodeGeneration.CSharp.CSharpClientGenerator.BaseSettings">
            <summary>Gets the base settings.</summary>
        </member>
        <member name="M:NSwag.CodeGeneration.CSharp.CSharpClientGenerator.GenerateClientTypes(System.String,System.String,System.Collections.Generic.IEnumerable{NSwag.CodeGeneration.CSharp.Models.CSharpOperationModel})">
        ...
        <member name="M:NSwag.CodeGeneration.CSharp.CSharpClientGenerator.CreateOperationModel(NSwag.OpenApiOperation,NSwag.CodeGeneration.ClientGeneratorBaseSettings)">
            <summary>Creates an operation model.</summary>
            <param name="operation">The operation.</param>
            <param name="settings">The settings.</param>
            <returns>The operation model.</returns>
        </member>
        <member name="T:NSwag.CodeGeneration.CSharp.CSharpClientGeneratorSettings">
            <summary>Settings for the <see cref="T:NSwag.CodeGeneration.CSharp.CSharpClientGenerator"/>.</summary>
        </member>
        <member name="M:NSwag.CodeGeneration.CSharp.CSharpClientGeneratorSettings.#ctor">
            <summary>Initializes a new instance of the <see cref="T:NSwag.CodeGeneration.CSharp.CSharpClientGeneratorSettings"/> class.</summary>
        </member>
        <member name="P:NSwag.CodeGeneration.CSharp.CSharpClientGeneratorSettings.ClientBaseClass">
            <summary>Gets or sets the full name of the base class.</summary>
        </member>
        <member name="P:NSwag.CodeGeneration.CSharp.CSharpClientGeneratorSettings.ConfigurationClass">
            <summary>Gets or sets the full name of the configuration class (<see cref="P:NSwag.CodeGeneration.CSharp.CSharpClientGeneratorSettings.ClientBaseClass"/> must be set).</summary>
        </member>
        <member name="P:NSwag.CodeGeneration.CSharp.CSharpClientGeneratorSettings.GenerateExceptionClasses">
            <summary>Gets or sets a value indicating whether to generate exception classes (default: true).</summary>
        </member>
        <member name="P:NSwag.CodeGeneration.CSharp.CSharpClientGeneratorSettings.ExceptionClass">
            <summary>Gets or sets the name of the exception class (supports the '{controller}' placeholder, default 'ApiException').</summary>
        </member>
        <member name="P:NSwag.CodeGeneration.CSharp.CSharpClientGeneratorSettings.InjectHttpClient">
            <summary>Gets or sets a value indicating whether an HttpClient instance is injected into the client (default: true).</summary>
        </member>
        <member name="P:NSwag.CodeGeneration.CSharp.CSharpClientGeneratorSettings.DisposeHttpClient">
        ...
        <member name="P:NSwag.CodeGeneration.CSharp.CSharpClientGeneratorSettings.ProtectedMethods">
            <summary>Gets or sets the list of methods with a protected access modifier ("classname.methodname").</summary>
        </member>
        <member name="P:NSwag.CodeGeneration.CSharp.CSharpClientGeneratorSettings.UseHttpClientCreationMethod">
        ...
        <member name="P:NSwag.CodeGeneration.CSharp.CSharpClientGeneratorSettings.UseHttpRequestMessageCreationMethod">
        ...
        <member name="P:NSwag.CodeGeneration.CSharp.CSharpClientGeneratorSettings.WrapDtoExceptions">
        ...
        <member name="P:NSwag.CodeGeneration.CSharp.CSharpClientGeneratorSettings.ClientClassAccessModifier">
            <summary>Gets or sets the client class access modifier (default: public).</summary>
        </member>
        <member name="P:NSwag.CodeGeneration.CSharp.CSharpClientGeneratorSettings.UseBaseUrl">
            <summary>Gets or sets a value indicating whether to use and expose the base URL (default: true).</summary>
        </member>
        <member name="P:NSwag.CodeGeneration.CSharp.CSharpClientGeneratorSettings.GenerateBaseUrlProperty">
        ...
        <member name="P:NSwag.CodeGeneration.CSharp.CSharpClientGeneratorSettings.GenerateSyncMethods">
            <summary>Gets or sets a value indicating whether to generate synchronous methods (not recommended, default: false).</summary>
        </member>
        <member name="P:NSwag.CodeGeneration.CSharp.CSharpClientGeneratorSettings.HttpClientType">
            <summary>
        ...
        <member name="P:NSwag.CodeGeneration.CSharp.CSharpClientGeneratorSettings.ParameterDateTimeFormat">
            <summary>Gets or sets the format for DateTime type method parameters (default: "s").</summary>
        </member>
        <member name="P:NSwag.CodeGeneration.CSharp.CSharpClientGeneratorSettings.ParameterDateFormat">
            <summary>Gets or sets the format for Date type method parameters (default: "yyyy-MM-dd").</summary>
        </member>
        <member name="P:NSwag.CodeGeneration.CSharp.CSharpClientGeneratorSettings.GenerateUpdateJsonSerializerSettingsMethod">
        ...
        <member name="P:NSwag.CodeGeneration.CSharp.CSharpClientGeneratorSettings.UseRequestAndResponseSerializationSettings">
        ...
        <member name="P:NSwag.CodeGeneration.CSharp.CSharpClientGeneratorSettings.SerializeTypeInformation">
        ...
        <member name="P:NSwag.CodeGeneration.CSharp.CSharpClientGeneratorSettings.QueryNullValue">
            <summary>Gets or sets the null value used for query parameters which are null (default: '').</summary>
        </member>
        <member name="P:NSwag.CodeGeneration.CSharp.CSharpClientGeneratorSettings.ExposeJsonSerializerSettings">
            <summary>Gets or sets a value indicating whether to expose the JsonSerializerSettings property (default: false).</summary>
        </member>
        <member name="T:NSwag.CodeGeneration.CSharp.CSharpControllerGenerator">
            <summary>Generates the CSharp service client code. </summary>
        </member>
        <member name="M:NSwag.CodeGeneration.CSharp.CSharpControllerGenerator.#ctor(NSwag.OpenApiDocument,NSwag.CodeGeneration.CSharp.CSharpControllerGeneratorSettings)">
            <summary>Initializes a new instance of the <see cref="T:NSwag.CodeGeneration.CSharp.CSharpControllerGenerator" /> class.</summary>
            <param name="document">The Swagger document.</param>
            <param name="settings">The settings.</param>
            <exception cref="T:System.ArgumentNullException"><paramref name="document" /> is <see langword="null" />.</exception>
        </member>
        <member name="M:NSwag.CodeGeneration.CSharp.CSharpControllerGenerator.#ctor(NSwag.OpenApiDocument,NSwag.CodeGeneration.CSharp.CSharpControllerGeneratorSettings,NJsonSchema.CodeGeneration.CSharp.CSharpTypeResolver)">
            <summary>Initializes a new instance of the <see cref="T:NSwag.CodeGeneration.CSharp.CSharpControllerGenerator" /> class.</summary>
            <param name="document">The Swagger document.</param>
            <param name="settings">The settings.</param>
            <param name="resolver">The resolver.</param>
        ...
        <member name="P:NSwag.CodeGeneration.CSharp.CSharpControllerGenerator.Settings">
            <summary>Gets or sets the generator settings.</summary>
        </member>
        <member name="P:NSwag.CodeGeneration.CSharp.CSharpControllerGenerator.BaseSettings">
            <summary>Gets the base settings.</summary>
        </member>
        <member name="M:NSwag.CodeGeneration.CSharp.CSharpControllerGenerator.GenerateAllClientTypes">
            <summary>Generates the client types.</summary>
            <returns>The code artifact collection.</returns>
        </member>
        <member name="M:NSwag.CodeGeneration.CSharp.CSharpControllerGenerator.GenerateClientTypes(System.String,System.String,System.Collections.Generic.IEnumerable{NSwag.CodeGeneration.CSharp.Models.CSharpOperationModel})">
            <summary>Generates the client class.</summary>
            <param name="controllerName">Name of the controller.</param>
            <param name="controllerClassName">Name of the controller class.</param>
            <param name="operations">The operations.</param>
        ...
        <member name="M:NSwag.CodeGeneration.CSharp.CSharpControllerGenerator.CreateOperationModel(NSwag.OpenApiOperation,NSwag.CodeGeneration.ClientGeneratorBaseSettings)">
            <summary>Creates an operation model.</summary>
            <param name="operation">The operation.</param>
            <param name="settings">The settings.</param>
            <returns>The operation model.</returns>
        </member>
        <member name="T:NSwag.CodeGeneration.CSharp.CSharpControllerGeneratorSettings">
            <summary>Settings for the <see cref="T:NSwag.CodeGeneration.CSharp.CSharpControllerGenerator"/>.</summary>
        </member>
        <member name="M:NSwag.CodeGeneration.CSharp.CSharpControllerGeneratorSettings.#ctor">
            <summary>Initializes a new instance of the <see cref="T:NSwag.CodeGeneration.CSharp.CSharpControllerGeneratorSettings"/> class.</summary>
        </member>
        <member name="M:NSwag.CodeGeneration.CSharp.CSharpControllerGeneratorSettings.GetRouteName(NSwag.OpenApiOperation)">
            <summary>Returns the route name for a controller method.</summary>
            <param name="operation">Swagger operation</param>
            <returns>Route name.</returns>
        </member>
        <member name="P:NSwag.CodeGeneration.CSharp.CSharpControllerGeneratorSettings.ControllerBaseClass">
            <summary>Gets or sets the full name of the base class.</summary>
        </member>
        <member name="P:NSwag.CodeGeneration.CSharp.CSharpControllerGeneratorSettings.ControllerStyle">
            <summary>Gets or sets the controller generation style (partial, abstract; default: partial).</summary>
        </member>
        <member name="P:NSwag.CodeGeneration.CSharp.CSharpControllerGeneratorSettings.ControllerTarget">
            <summary>Gets or sets the controller target framework.</summary>
        </member>
        <member name="P:NSwag.CodeGeneration.CSharp.CSharpControllerGeneratorSettings.UseCancellationToken">
            <summary>Gets or sets a value indicating whether to allow adding cancellation token </summary>
        </member>
        <member name="P:NSwag.CodeGeneration.CSharp.CSharpControllerGeneratorSettings.RouteNamingStrategy">
            <summary>Gets or sets the strategy for naming routes (default: CSharpRouteNamingStrategy.None).</summary>
        </member>
        <member name="P:NSwag.CodeGeneration.CSharp.CSharpControllerGeneratorSettings.GenerateModelValidationAttributes">
            <summary>Gets or sets a value indicating whether to add model validation attributes.</summary>
        </member>
        <member name="P:NSwag.CodeGeneration.CSharp.CSharpControllerGeneratorSettings.UseActionResultType">
            <summary>Gets or sets a value indicating whether ASP.Net Core (2.1) ActionResult type is used (default: false).</summary>
        </member>
        <member name="P:NSwag.CodeGeneration.CSharp.CSharpControllerGeneratorSettings.BasePath">
            <summary>Gets or sets the base path on which the API is served, which is relative to the Host.</summary>
        </member>
        <member name="T:NSwag.CodeGeneration.CSharp.CSharpGeneratorBase">
            <summary>The CSharp generator base class.</summary>
        </member>
        <member name="M:NSwag.CodeGeneration.CSharp.CSharpGeneratorBase.#ctor(NSwag.OpenApiDocument,NSwag.CodeGeneration.CSharp.CSharpGeneratorBaseSettings,NJsonSchema.CodeGeneration.CSharp.CSharpTypeResolver)">
            <summary>Initializes a new instance of the <see cref="T:NSwag.CodeGeneration.CSharp.CSharpGeneratorBase"/> class.</summary>
            <param name="document">The document.</param>
            <param name="settings">The settings.</param>
            <param name="resolver">The resolver.</param>
        </member>
        <member name="M:NSwag.CodeGeneration.CSharp.CSharpGeneratorBase.GetTypeName(NJsonSchema.JsonSchema,System.Boolean,System.String)">
        ...
        <member name="M:NSwag.CodeGeneration.CSharp.CSharpGeneratorBase.GetBinaryResponseTypeName">
            <summary>
        ...
        <member name="M:NSwag.CodeGeneration.CSharp.CSharpGeneratorBase.CreateResolverWithExceptionSchema(NJsonSchema.CodeGeneration.CSharp.CSharpGeneratorSettings,NSwag.OpenApiDocument)">
            <summary>Creates a new resolver, adds the given schema definitions and registers an exception schema if available.</summary>
            <param name="settings">The settings.</param>
            <param name="document">The document </param>
        </member>
        <member name="M:NSwag.CodeGeneration.CSharp.CSharpGeneratorBase.GenerateFile(System.Collections.Generic.IEnumerable{NJsonSchema.CodeGeneration.CodeArtifact},System.Collections.Generic.IEnumerable{NJsonSchema.CodeGeneration.CodeArtifact},NSwag.CodeGeneration.ClientGeneratorOutputType)">
        ...
        <member name="M:NSwag.CodeGeneration.CSharp.CSharpGeneratorBase.GenerateDtoTypes">
            <summary>Generates all DTO types.</summary>
            <returns>The code artifact collection.</returns>
        </member>
        <member name="T:NSwag.CodeGeneration.CSharp.CSharpGeneratorBaseSettings">
            <summary>Settings for the <see cref="T:NSwag.CodeGeneration.CSharp.CSharpGeneratorBase"/>.</summary>
        </member>
        <member name="M:NSwag.CodeGeneration.CSharp.CSharpGeneratorBaseSettings.#ctor">
            <summary>Initializes a new instance of the <see cref="T:NSwag.CodeGeneration.CSharp.CSharpClientGeneratorSettings"/> class.</summary>
        </member>
        <member name="P:NSwag.CodeGeneration.CSharp.CSharpGeneratorBaseSettings.CSharpGeneratorSettings">
            <summary>Gets the CSharp generator settings.</summary>
        </member>
        <member name="P:NSwag.CodeGeneration.CSharp.CSharpGeneratorBaseSettings.CodeGeneratorSettings">
            <summary>Gets the code generator settings.</summary>
        </member>
        <member name="P:NSwag.CodeGeneration.CSharp.CSharpGeneratorBaseSettings.AdditionalNamespaceUsages">
            <summary>Gets or sets the additional namespace usages.</summary>
        </member>
        <member name="P:NSwag.CodeGeneration.CSharp.CSharpGeneratorBaseSettings.AdditionalContractNamespaceUsages">
            <summary>Gets or sets the additional contract namespace usages.</summary>
        </member>
        <member name="P:NSwag.CodeGeneration.CSharp.CSharpGeneratorBaseSettings.ResponseArrayType">
            <summary>Gets or sets the array type of operation responses (i.e. the method return type).</summary>
        </member>
        <member name="P:NSwag.CodeGeneration.CSharp.CSharpGeneratorBaseSettings.ResponseDictionaryType">
            <summary>Gets or sets the dictionary type of operation responses (i.e. the method return type).</summary>
        </member>
        <member name="P:NSwag.CodeGeneration.CSharp.CSharpGeneratorBaseSettings.ParameterArrayType">
            <summary>Gets or sets the array type of operation parameters.</summary>
        </member>
        <member name="P:NSwag.CodeGeneration.CSharp.CSharpGeneratorBaseSettings.ParameterDictionaryType">
        ...
        <member name="M:NSwag.CodeGeneration.CSharp.Models.CSharpClientTemplateModel.#ctor(System.String,System.String,System.Collections.Generic.IEnumerable{NSwag.CodeGeneration.CSharp.Models.CSharpOperationModel},NJsonSchema.JsonSchema,NSwag.OpenApiDocument,NSwag.CodeGeneration.CSharp.CSharpClientGeneratorSettings)">
        ...
        <member name="P:NSwag.CodeGeneration.CSharp.Models.CSharpClientTemplateModel.ParameterDateFormat">
        ...
        <member name="P:NSwag.CodeGeneration.CSharp.Models.CSharpClientTemplateModel.UseRequestAndResponseSerializationSettings">
            <summary>Gets or sets a value indicating whether to generate different request and response serialization settings (default: false).</summary>
        </member>
        ...
        <member name="P:NSwag.CodeGeneration.CSharp.Models.CSharpClientTemplateModel.Title">
            <summary>Gets the Title.</summary>
        </member>
        <member name="P:NSwag.CodeGeneration.CSharp.Models.CSharpClientTemplateModel.Description">
            <summary>Gets the Description.</summary>
        </member>
        <member name="P:NSwag.CodeGeneration.CSharp.Models.CSharpClientTemplateModel.Version">
            <summary>Gets the API version.</summary>
        </member>
        <member name="T:NSwag.CodeGeneration.CSharp.Models.CSharpControllerOperationModel">
            <summary>The CSharp controller operation model.</summary>
        </member>
        <member name="M:NSwag.CodeGeneration.CSharp.Models.CSharpControllerOperationModel.#ctor(NSwag.OpenApiOperation,NSwag.CodeGeneration.CSharp.CSharpControllerGeneratorSettings,NSwag.CodeGeneration.CSharp.CSharpControllerGenerator,NJsonSchema.CodeGeneration.CSharp.CSharpTypeResolver)">
            <summary>Initializes a new instance of the <see cref="T:NSwag.CodeGeneration.CSharp.Models.CSharpControllerOperationModel" /> class.</summary>
            <param name="operation">The operation.</param>
            <param name="settings">The settings.</param>
            <param name="generator">The generator.</param>
            <param name="resolver">The resolver.</param>
        </member>
        <member name="P:NSwag.CodeGeneration.CSharp.Models.CSharpControllerOperationModel.ResultType">
        ...
        <member name="T:NSwag.CodeGeneration.CSharp.Models.CSharpControllerTarget">
            <summary>The CSharp controller target framework.</summary>
        </member>
        <member name="F:NSwag.CodeGeneration.CSharp.Models.CSharpControllerTarget.AspNet">
            <summary>ASP.NET MVC.</summary>
        </member>
        <member name="F:NSwag.CodeGeneration.CSharp.Models.CSharpControllerTarget.AspNetCore">
        ...
        <member name="M:NSwag.CodeGeneration.CSharp.Models.CSharpControllerTemplateModel.#ctor(System.String,System.Collections.Generic.IEnumerable{NSwag.CodeGeneration.CSharp.Models.CSharpOperationModel},NSwag.OpenApiDocument,NSwag.CodeGeneration.CSharp.CSharpControllerGeneratorSettings)">
        ...
        <member name="P:NSwag.CodeGeneration.CSharp.Models.CSharpControllerTemplateModel.IsAspNetCore">
            <summary>Gets or sets a value indicating whether the output should target ASP.NET Core.</summary>
        </member>
        <member name="P:NSwag.CodeGeneration.CSharp.Models.CSharpControllerTemplateModel.IsAspNet">
        ...
        <member name="P:NSwag.CodeGeneration.CSharp.Models.CSharpControllerTemplateModel.GenerateModelValidationAttributes">
            <summary>Gets a value indicating whether to allow adding model validation attributes</summary>
        </member>
        <member name="P:NSwag.CodeGeneration.CSharp.Models.CSharpControllerTemplateModel.RequiredAttributeType">
        ...
        <member name="M:NSwag.CodeGeneration.CSharp.Models.CSharpExceptionDescriptionModel.#ctor(System.String,System.String,System.String,NSwag.CodeGeneration.CSharp.CSharpClientGeneratorSettings)">
        ...
        <member name="M:NSwag.CodeGeneration.CSharp.Models.CSharpFileTemplateModel.#ctor(System.Collections.Generic.IEnumerable{NJsonSchema.CodeGeneration.CodeArtifact},System.Collections.Generic.IEnumerable{NJsonSchema.CodeGeneration.CodeArtifact},NSwag.CodeGeneration.ClientGeneratorOutputType,NSwag.OpenApiDocument,NSwag.CodeGeneration.CSharp.CSharpGeneratorBaseSettings,NSwag.CodeGeneration.CSharp.CSharpGeneratorBase,NJsonSchema.CodeGeneration.CSharp.CSharpTypeResolver)">
        ...
        <member name="M:NSwag.CodeGeneration.CSharp.Models.CSharpOperationModel.#ctor(NSwag.OpenApiOperation,NSwag.CodeGeneration.CSharp.CSharpGeneratorBaseSettings,NSwag.CodeGeneration.CSharp.CSharpGeneratorBase,NJsonSchema.CodeGeneration.CSharp.CSharpTypeResolver)">
        ...
        <member name="P:NSwag.CodeGeneration.CSharp.Models.CSharpOperationModel.RequiresAuthentication">
            <summary>True if the operation has any security schemes</summary>
        </member>
        <member name="P:NSwag.CodeGeneration.CSharp.Models.CSharpOperationModel.Security">
            <summary>Gets the security schemas that apply to this operation</summary>
        </member>
        <member name="M:NSwag.CodeGeneration.CSharp.Models.CSharpOperationModel.GetParameterVariableName(NSwag.OpenApiParameter,System.Collections.Generic.IEnumerable{NSwag.OpenApiParameter})">
            <summary>Gets the name of the parameter variable.</summary>
            <param name="parameter">The parameter.</param>
            <param name="allParameters">All parameters.</param>
            <returns>The parameter variable name.</returns>
        </member>
        <member name="M:NSwag.CodeGeneration.CSharp.Models.CSharpOperationModel.ResolveParameterType(NSwag.OpenApiParameter)">
            <summary>Resolves the type of the parameter.</summary>
            <param name="parameter">The parameter.</param>
            <returns>The parameter type name.</returns>
        </member>
        <member name="M:NSwag.CodeGeneration.CSharp.Models.CSharpOperationModel.CreateResponseModel(NSwag.OpenApiOperation,System.String,NSwag.OpenApiResponse,NJsonSchema.JsonSchema,NSwag.CodeGeneration.IClientGenerator,NJsonSchema.CodeGeneration.TypeResolverBase,NSwag.CodeGeneration.ClientGeneratorBaseSettings)">
        ...
        <member name="M:NSwag.CodeGeneration.CSharp.Models.CSharpParameterModel.#ctor(System.String,System.String,System.String,NSwag.OpenApiParameter,System.Collections.Generic.IList{NSwag.OpenApiParameter},NJsonSchema.CodeGeneration.CodeGeneratorSettingsBase,NSwag.CodeGeneration.IClientGenerator,NJsonSchema.CodeGeneration.TypeResolverBase)">
        ...
        <member name="P:NSwag.CodeGeneration.CSharp.Models.CSharpParameterModel.IsValidIdentifier">
        ...
        <member name="M:NSwag.CodeGeneration.CSharp.Models.CSharpTemplateModelBase.#ctor(System.String,NSwag.CodeGeneration.CSharp.CSharpGeneratorBaseSettings)">
