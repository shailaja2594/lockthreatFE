...
<script type='text/html' id='dxdd-routed-connector-selection'>
    <div class="dxdd-connector dxrd-selected dxd-state-selected" data-bind="styleunit: position, dxAction: function() {}, visible: isVisible">
        <!-- ko template: { name: 'dxdd-routed-connection-line' } -->
        <!-- /ko -->
        <!-- ko foreach: routeLineWrappers -->
        <!-- ko ifnot: isLocked -->
...
<script type="text/html" id="dx-masterDetail-editor-keyColumn">
    <div class="criteria-operator-text dxd-filter-editor-text-color criteria-operator-item-field dxd-filter-editor-field-back-color stylized" data-bind="text: queryName"></div>
...
<script type="text/html" id="dx-masterdetail-editor-setColumn">
    <div class="criteria-operator-text dxd-filter-editor-text-color clickable criteria-operator-item-field dxd-filter-editor-field-back-color" data-bind="text: target.column() || target.selectColumnText(), dxAction: showPopup, css: { 'dxd-state-selected': target.isSelected, 'default': !target.column() }"></div>
</script>
...
<script id="dxqb-filtereditor-changeparameter" type="text/html">
    ...
    <div class="criteria-operator-text dxd-filter-editor-text-color clickable " data-bind="text: target.parameterName, dxAction: showPopup, css: { 'dxd-state-selected': target.isSelected, 'default': target.isDefaultTextDisplayed() }, visible: $data.target.isEditable() === false"></div>
</script>
...
<script type="text/html" id="dxrd-wizard-add-queries-page">
    <div class="dxrd-wizard-page dxrd-wizard-add-queries-page">
        ...
        <!-- /ko -->
        <div class="dxrd-wizard-load-panel dxd-text-primary" data-bind="dxLoadPanel: loadPanelViewModel($element)">
        </div>
    </div>
</script>
    ...
    <div class="dx-fieldset" style="height:100%">
        <div class="dx-collectioneditor" style="height:100%">
            <div class="dxrd-datasource-parameters-collection">
                <div class="dxrd-datasource-parameters-container dxd-border-secondary" data-bind="dxScrollView: { showScrollbar: 'onHover' }">
                    ...
                    <div class="dx-collectioneditor-items" data-bind="foreach: values">
                        <div class="dx-background-inheritor dxd-back-highlighted dxd-state-selected" data-bind="with: $parent.createCollectionItemWrapper($parents[1], $index)">
                            <div class="dx-collectioneditor-item-container dx-fontsize-reestablished dxd-list-item-back-color" data-bind="dxAction: $parents[1].select, css: { 'dxd-state-selected dxd-back-secondary' : $parents[1].selectedIndex() === $index() }">
...
<script type="text/html" id="dxrd-select-control">
    ...
    <!-- ko if: !aceAvailable -->
    <div class="dxrd-wizard-list dxrd-create-query-page-editor dx-default-border-style dxd-border-secondary" data-bind="dxTextArea: { value: sqlString, valueChangeEvent: 'keyup input blur', readOnly: disableCustomSql() }"></div>
    <!-- /ko -->
    <!-- ko if: aceAvailable -->
    <div class="dxrd-create-query-page-editor dxrd-create-query-page-editor-border dxd-border-secondary">
...
<script type="text/html" id="dx-editor-addons">
    <!-- ko if: visible -->
    <div class="dxrd-editormenu-box dxd-property-grid-menu-box-color dxd-back-contrast" data-bind="dxAction: showPopup, css: editorMenuButtonCss">
...
<script type="text/html" id="dx-combobox-editable">
    <div data-bind="dxSelectBox: getOptions({ items: values, value: value, valueExpr: 'value', displayExpr: 'displayValue', disabled: disabled, placeholder: $root.dx.Analytics.Localization.selectPlaceholder(), acceptCustomValue: true, onCustomItemCreating: function(arg) { return { value: arg.text, displayValue: arg.text }; } })"></div>
</script>
            ...
            <div class="dx-accordion-content">
                ...
                <div class="dx-collectioneditor-items" data-bind="foreach: values">
                    <div data-bind="with: $parent.createCollectionItemWrapper($parents[1], $index)">
                        <div class="dx-collectioneditor-item-container dxd-button-back-color dxd-state-normal dxd-back-highlighted" data-bind="dxAction: $parents[1].select, css: { 'dxd-state-selected' : $parents[1].selectedIndex() === $index() }">
                            <div class="dx-collection-item"></div>
                        </div>
                    </div>
                </div>
...
<script type="text/html" id="dx-expressioneditor-categories">
    <div class="dx-expressioneditor-tools-tab-content-wrapper dxd-border-secondary " data-bind="dxScrollView: { showScrollbar: 'onHover' }">
        ...
        <div class="dx-expressioneditor-tools-tab-category dxd-list-item-back-color dxd-back-highlighted" data-bind="css: {'dxd-state-selected': content.isSelected }, text: displayName, dxAction: function() { $parent.click($data.content) }">
        </div>
        <!-- /ko -->
        <!-- /ko -->
    </div>
...
<script type="text/html" id="dx-expressioneditor-category-accordion">
    <div class="dx-fieldset" style="margin: 0;">
        <div data-bind="dxdAccordion: { collapsed: collapsed }">
            <div class="dx-accordion-header dx-expressioneditor-tools-tab-accordion-header dxd-list-item-back-color dxd-back-highlighted" data-bind="css: {'dxd-state-selected': $data.isSelected }, dxAction: function() { $data.updateContent($data.allItems(), $data.isSelected); $parent.click($data.content) }">
                <div class=" dx-collapsing-image" data-bind="template: 'dxrd-svg-collapsed', css: { 'dx-image-expanded': !collapsed() }" style="display:inline-block;"></div>
                <span class="dx-expressioneditor-tools-tab-header" data-bind="text: displayName"></span>
            </div>
            <div class="dx-accordion-content">
                <!-- ko foreach: items-->
                <div class="dx-expressioneditor-tools-tab-item dxd-text-primary dxd-list-item-back-color dxd-back-highlighted" data-bind="css: {'dxd-state-selected': isSelected }, text: $data.display, dxAction: function() { $parent.updateContent($data.data, $data.isSelected); $parents[1].click($parent.content); }"></div>
                <!-- /ko -->
            </div>
        </div>
    </div>
...
<script id="dx-filtereditor-value" type="text/html">
    <div class="criteria-operator-item" data-bind="visible: isEditable">
        ...
        <div class="criteria-operator-item-editor" data-bind="focus: isEditable, dxSelectBox: { value: _value, dataSource: dataSource, valueExpr: 'value', displayExpr: 'display', searchEnabled: true, onFocusOut: function() { isEditable(false); }}"></div>
        <!-- /ko -->
        <!-- ko if: $data.items.length > 0 && typeof $data.items[0] !== "object" -->
        <div class="criteria-operator-item-editor" data-bind="focus: isEditable, dxSelectBox: { value: _value, dataSource: dataSource, acceptCustomValue: true, searchEnabled: true, onFocusOut: function() { isEditable(false); }}"></div>
        <!-- /ko -->
    </div>
    <div class="criteria-operator-text dxd-filter-editor-text-color criteria-operator-item-value dxd-filter-editor-value-back-color" data-bind="visible: !isEditable()">
...
<script type="text/html" id="dx-filtereditor-change">
    <div class="criteria-operator-text dxd-filter-editor-text-color clickable" data-bind="text: target.displayType, dxAction: showPopup, css: target.css"></div>
</script>

<script type="text/html" id="dx-filtereditor-changeParameter">
    <div class="criteria-operator-text dxd-filter-editor-text-color clickable " data-bind="text: target.parameterName(), dxAction: showPopup, css: { 'dxd-state-selected': target.isSelected }"></div>
</script>

<script type="text/html" id="dx-filtereditor-changeProperty">
    <div class="criteria-operator-text dxd-filter-editor-text-color clickable" data-bind="text: target.displayName, dxAction: showPopup, css: { 'dxd-state-selected': target.isSelected }"></div>
</script>
...
<script type="text/html" id="dxrd-collectionactions-template">
    ...
    <div data-bind="dxPopup: { width: 235, height: 'auto',
        ...
        <!-- ko foreach: actions -->
        <div class="dxrd-action-item dxd-button-back-color dxd-state-normal dxd-back-highlighted" data-bind="dxAction: clickAction, css: { 'dxrd-disabled-button': disabled }">
...
<script type="text/html" id="dxrd-menubutton-template-base">
    ...
    <div class="dxrd-menu-button dxd-toolbox-back-color dxd-border-primary dxd-back-primary2">
        ...
        <div class="dxrd-menu-button-image dxd-button-back-color dxd-state-normal dxd-back-highlighted" data-bind="dxAction: function(e) { if(stopPropagation) { stopPropagation = false; } else { toggleAppMenu() } }, template: 'dxrd-svg-menu-menu', css: {'dxd-state-active': appMenuVisible }"></div>
        <div class="dxd-menu-back-color dxd-back-primary2" data-bind="dxPopup: {
            ...
            <div class="dxrd-menu-item dxd-text-primary dxd-list-item-back-color dxd-back-highlighted" data-bind="dxAction: function(e) { if(disabled && !disabled() || !disabled) { $root.toggleAppMenu(); clickAction($root.model(), e); }}, css: { 'dxrd-disabled-button': disabled }, visible: visible">
    ...
    <div style="height:100%" class="dxd-text-primary">
        ...
        <div class="dx-property-grid-header">
            <div class="dx-property-grid-header-content">
                ...
                <div class="dx-property-grid-search-group dx-property-gread-search-collapsed" data-bind="css: { 'dx-property-gread-search-collapsed': !isSearching() }">
                    <div class="dx-property-grid-sorting-action dxd-button-back-color dxd-state-normal dxd-back-highlighted dxd-back-primary2" data-bind="css: { 'dxd-state-active': isSearching }, dxButtonWithTemplate: { onClick: switchSearchBox, icon: 'dxrd-svg-properties-search', iconClass: 'image-search' }"></div>
        ...
        visible: popupService.visible }">
                <div data-options="dxTemplate: { name: 'content' }">
                    ...
                    <div class="dxrd-editor-menu-caption dxd-text-primary" data-bind="text: popupService.title"></div>
                    <!-- /ko -->
                    <!-- ko foreach: popupService.actions -->
                    <!-- ko if: (!visible || visible && visible()) -->
                    <div class="dxrd-editor-menu-item dxd-list-item-back-color dxd-back-highlighted dxd-state-normal" data-bind="dxAction: action">
                        <div class="dxrd-menuitem-box dxd-property-grid-menu-box-color dxd-back-contrast">
                            <div class="dxrd-menuitem-box-inside dxd-back-secondary"></div>
                        </div>
                        <span class="dxrd-editor-menu-title dxd-text-primary" data-bind="text: title"></span>
                    </div>
                    <!-- /ko -->
                    <!-- /ko -->
                </div>
...
<script type="text/html" id="dxrd-right-panel-template-base">
    <div class="dx-shadow dxd-border-secondary" data-bind="styleunit: { width: tabPanel.headerWidth }, css: tabPanel.cssClasses({'border': !tabPanel.collapsed()})">
        <div class="dxrd-right-panel-collapse dxd-back-primary dxd-button-back-color dxd-state-normal dxd-back-highlighted" data-bind="styleunit: { width: tabPanel.headerWidth }, css: tabPanel.cssClasses(), dxAction: function() { tabPanel.collapsed(!tabPanel.collapsed()); }, attr: { title: tabPanel.toggleCollapsedText }">
        ...
        <div class="dxrd-right-tabs dxd-side-panel-tabs-back-color dxd-back-contrast" data-bind="css: tabPanel.cssClasses()">
            <!-- ko foreach: tabPanel.tabs -->
            <div class="dxrd-tab-item dxd-side-panel-tab-back-color dxd-back-highlighted" data-bind="dxAction: $parent.tabPanel.selectTab, css: { 'dxd-state-active dxd-state-no-hover': active, 'dxrd-tab-item-disabled': disabled }, attr: { title: text }, visible: visible">
