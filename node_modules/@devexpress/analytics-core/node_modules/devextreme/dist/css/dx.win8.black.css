...
.dx-list-item-after-bag .dx-list-reorder-handle {
  width: 45px;
  height: 45px;
  background-image: url(data:image/png;base64,iVBORw0KGgoAAAANSUhEUgAAADgAAAA4CAQAAAACj/OVAAAAhklEQVRYw+3WwQmAMAyF4ddpOpPbZBtn6jR6sKKoIIhJK/495PpBSJOXJsW+BAgICAgI+B0wSypxYNYgafQgr8CF04m0R4LdgRt3JF3AtZn7WjxbapUwSVZ5i5hSexsCDAe72KVOH78jkCkF7GN5h5+n8APcIGI0CFENYiJRHxAQEBDwX+AMetRkAVShXvIAAAAASUVORK5CYII=);
}
...
.dx-datebox-wrapper .dx-popup-bottom .dx-toolbar-before .dx-button-today .dx-button-content {
  background: url(data:image/png;base64,) 50% 50% no-repeat;
  background-size: 19px 19px;
}
...
.dx-datebox-wrapper .dx-popup-bottom .dx-popup-done .dx-button-content {
  background: url(data:image/png;base64,) 50% 50% no-repeat;
  background-size: 19px 19px;
}
...
.dx-state-focused.dx-radiobutton .dx-radiobutton-icon:before {
  background-color: #ffffff;
  -webkit-box-shadow: inset #bebebe 0 0 3px;
          box-shadow: inset #bebebe 0 0 3px;
}
...
.dx-datagrid-rowsview .dx-item-modified {
  outline: 2px solid #5bff8c;
}
.dx-datagrid-rowsview .dx-row-removed > td {
  background-color: #5bff8c;
  border-top: 1px solid #5bff8c;
  border-bottom: 1px solid #5bff8c;
}
