...
.dx-theme-win8-typography h1,
.dx-theme-win8-typography .dx-font-xl {
  font-weight: 400;
  font-size: 42pt;
  line-height: 1.1429;
}
.dx-theme-win8-typography h2,
.dx-theme-win8-typography .dx-font-l {
  font-weight: 200;
  font-size: 32pt;
  line-height: 1.1429;
}
.dx-theme-win8-typography h3,
.dx-theme-win8-typography .dx-font-m {
  font-weight: 200;
  font-size: 24pt;
  line-height: 1.3636;
}
.dx-theme-win8-typography h4 {
  font-weight: 200;
  font-size: 20pt;
  line-height: 1.2;
}
...
.dx-theme-win8-typography h6,
.dx-theme-win8-typography small,
.dx-theme-win8-typography .dx-font-xs {
  font-weight: 200;
  font-size: 8pt;
  line-height: 1.6667;
}
.dx-theme-win8-typography b,
.dx-theme-win8-typography strong {
  font-weight: 700;
}
.dx-theme-win8-typography.dx-device-phone {
  font-size: 11pt;
}
.dx-theme-win8-typography.dx-device-phone h1,
.dx-theme-win8-typography.dx-device-phone .dx-font-xl {
  font-size: 22pt;
}
.dx-theme-win8-typography.dx-device-phone h2,
.dx-theme-win8-typography.dx-device-phone .dx-font-l {
  font-size: 20pt;
}
.dx-theme-win8-typography.dx-device-phone h3,
.dx-theme-win8-typography.dx-device-phone .dx-font-m {
  font-size: 16pt;
}
.dx-theme-win8-typography.dx-device-phone h4,
.dx-theme-win8-typography.dx-device-phone .dx-font-s {
  font-size: 14pt;
}
.dx-theme-win8-typography.dx-device-phone h5 {
  font-size: 12pt;
}
.dx-theme-win8-typography.dx-device-phone h6,
.dx-theme-win8-typography.dx-device-phone small,
.dx-theme-win8-typography.dx-device-phone .dx-font-xs {
  font-size: 8pt;
}
.dx-theme-marker {
  font-family: "dx.win8.white";
}
.dx-black-background {
...
.dx-device-phone .dx-button .dx-icon {
  width: 20px;
  height: 20px;
...
.dx-device-phone .dx-button-text {
  padding: 0 3px;
}
.dx-state-focused.dx-button {
  background: #80dbff;
}
.dx-state-focused.dx-button-danger {
  background: #e54d75;
}
.dx-state-focused.dx-button-success {
  background: #0de730;
}
.dx-state-hover.dx-button {
  background: #2bb0ca;
}
.dx-state-hover.dx-button-danger {
  background: #e12e5d;
}
.dx-state-hover.dx-button-success {
  background: #0bc629;
}
.dx-state-active.dx-button {
  background: #00b8ff;
}
.dx-state-active.dx-button-danger {
  background: #e54d75;
}
.dx-state-active.dx-button-success {
  background: #0de730;
}
...
.dx-device-phone .dx-scrollview-pull-down-image {
...
.dx-invalid .dx-checkbox-container .dx-checkbox-icon {
  border: 2px solid rgba(234, 68, 68, 0.4);
}
...
.dx-switch.dx-state-focused .dx-switch-off:before {
  background: #b2b2b2;
}
.dx-switch.dx-state-focused .dx-switch-on:before {
  background: #80dbff;
}
.dx-switch.dx-state-hover .dx-switch-off:before {
  background: #999999;
}
.dx-switch.dx-state-hover .dx-switch-on:before {
  background: #2bb0ca;
}
.dx-switch.dx-state-active .dx-switch-on:before {
  background: #00b8ff;
}
.dx-switch-handle {
...
.dx-rtl .dx-switch .dx-switch-off:after,
.dx-switch.dx-rtl .dx-switch-off:after {
  right: 0px;
  float: right;
}
.dx-rtl .dx-switch .dx-switch-on:after,
.dx-switch.dx-rtl .dx-switch-on:after {
  left: 0px;
  float: right;
}
.dx-rtl .dx-switch .dx-switch-on:before,
.dx-switch.dx-rtl .dx-switch-on:before {
  margin-right: 5px;
  margin-left: 0px;
}
...
.dx-device-phone .dx-tabs .dx-tab .dx-icon {
  width: 20px;
  height: 20px;
...
.dx-device-phone .dx-tabs .dx-tab .dx-tab-text {
  font-size: 12pt;
}
.dx-rtl .dx-tabs,
.dx-rtl.dx-tabs {
...
.dx-navbar-text-item .dx-navbar-item-badge {
  right: 0;
  margin-right: 5px;
}
.dx-device-phone .dx-navbar-item-badge {
  font-size: 10px;
  margin-right: 0;
  line-height: 13px;
  height: 14px;
}
.dx-device-phone .dx-navbar-text-item .dx-navbar-item-badge {
  margin-right: 5px;
}
.dx-device-phone .dx-rtl.dx-tabs .dx-navbar-item-badge {
  margin-right: 0;
  margin-left: -14px;
}
.dx-rtl .dx-tabs.dx-navbar,
.dx-rtl.dx-tabs.dx-navbar {
  text-align: right;
}
.dx-rtl .dx-tabs .dx-navbar-item-badge,
.dx-rtl.dx-tabs .dx-navbar-item-badge {
  margin-right: 0;
  margin-left: -22px;
}
.dx-rtl .dx-tabs .dx-navbar-text-item .dx-navbar-item-badge,
.dx-rtl.dx-tabs .dx-navbar-text-item .dx-navbar-item-badge {
  right: auto;
  left: 0;
  margin-right: 0;
...
.dx-state-focused .dx-clear-button-area .dx-icon-clear {
  background-color: #858585;
}
.dx-state-focused .dx-clear-button-area .dx-icon-clear:before {
  color: #000;
}
.dx-rtl .dx-clear-button-area .dx-icon-clear,
.dx-rtl.dx-clear-button-area .dx-icon-clear {
  right: auto;
  left: 3px;
}
.dx-invalid .dx-texteditor-input {
  border: 2px rgba(234, 68, 68, 0.4) solid;
}
...
.dx-state-focused.dx-searchbox .dx-icon-search {
  background-color: #858585;
}
.dx-state-focused.dx-searchbox .dx-icon-search:before {
  color: #000;
}
.dx-searchbox .dx-icon-search:before {
  vertical-align: middle;
...
.dx-rtl .dx-dropdowneditor .dx-texteditor-input,
.dx-rtl.dx-dropdowneditor .dx-texteditor-input {
  padding-right: 4px;
}
.dx-rtl .dx-dropdowneditor.dx-dropdowneditor-button-visible .dx-texteditor-input,
.dx-rtl.dx-dropdowneditor.dx-dropdowneditor-button-visible .dx-texteditor-input {
  padding-left: 34px;
}
...
.dx-list-toggle-delete-switch-container .dx-state-focused {
  background-color: transparent;
}
.dx-state-hover.dx-list-toggle-delete-switch {
  background-color: transparent;
}
...
.dx-rtl .dx-list-item.dx-state-active .dx-list-item-content {
  -webkit-transform: translate(-5px, 1px);
          transform: translate(-5px, 1px);
}
...
.dx-list-item-before-bag .dx-list-toggle-delete-switch.dx-state-active {
  background: transparent;
}
.dx-list-item-before-bag .dx-icon-toggle-delete {
  ...
  width: 25px;
  height: 25px;
  background-image: url(data:image/png;base64,);
...
.dx-list-item-after-bag .dx-list-reorder-handle {
  width: 45px;
  height: 45px;
  background-image: url(data:image/png;base64,);
}
...
.dx-device-phone .dx-list-static-delete-button-container .dx-list-static-delete-button .dx-icon {
  width: 22px;
  height: 22px;
  background-position: 2px 2px;
...
.dx-list-context-menucontent .dx-list-item {
  color: #ffffff;
}
.dx-device-phone .dx-list-group-header {
  font-size: 8pt;
}
.dx-device-phone .dx-list-item {
  font-size: 14pt;
}
.dx-device-phone .dx-list-item .dx-list-toggle-delete-button .dx-button-text {
  line-height: 2;
}
.dx-device-phone .dx-list-item-content {
  padding: 9px 10px;
}
.dx-device-phone .dx-list-item-before-bag .dx-icon-toggle-delete {
  width: 19px;
  height: 19px;
}
...
.dx-rtl .dx-list .dx-list-switchable-delete-button-container,
.dx-rtl.dx-list .dx-list-switchable-delete-button-container {
  padding-right: 5px;
  padding-left: 0px;
}
...
.dx-rtl .dx-list .dx-list-slide-item-wrapper.dx-state-active,
.dx-rtl.dx-list .dx-list-slide-item-wrapper.dx-state-active {
  right: auto;
  left: 0;
}
...
.dx-dropdownlist-popup-wrapper .dx-list-item.dx-state-active,
.dx-dropdownlist-popup-wrapper .dx-list-select-all.dx-state-active {
  color: #000;
}
.dx-dropdownlist-popup-wrapper .dx-list-item.dx-state-focused,
.dx-dropdownlist-popup-wrapper .dx-list-select-all.dx-state-focused {
  background-color: rgba(0, 184, 255, 0.6);
}
.dx-dropdownlist-popup-wrapper .dx-list-item .dx-checkbox-icon,
.dx-dropdownlist-popup-wrapper .dx-list-select-all .dx-checkbox-icon {
  border-color: #000;
}
.dx-dropdownlist-popup-wrapper .dx-list-item .dx-checkbox-checked .dx-checkbox-icon,
.dx-dropdownlist-popup-wrapper .dx-list-select-all .dx-checkbox-checked .dx-checkbox-icon {
  color: #000;
}
.dx-dropdownlist-popup-wrapper .dx-list-item .dx-checkbox-indeterminate .dx-checkbox-icon,
.dx-dropdownlist-popup-wrapper .dx-list-select-all .dx-checkbox-indeterminate .dx-checkbox-icon {
  background-color: #ffffff;
}
.dx-dropdownlist-popup-wrapper .dx-list-item .dx-checkbox-indeterminate .dx-checkbox-icon:before,
.dx-dropdownlist-popup-wrapper .dx-list-select-all .dx-checkbox-indeterminate .dx-checkbox-icon:before {
  background-color: #000;
}
.dx-dropdownlist-popup-wrapper .dx-list-item-selected {
  color: #ffffff;
}
.dx-device-phone .dx-dropdownlist-popup-wrapper .dx-list-item.dx-state-active .dx-list-item-content {
...
@media (max-width: 320px) {
  .dx-datebox-wrapper .dx-popup-fullscreen-width .dx-popup-content {
    margin: 0;
  }
}
.dx-datebox-wrapper .dx-popup-bottom {
  left: 0;
  margin: 0;
  width: 100%;
  background-color: #ffffff;
...
.dx-datebox-wrapper .dx-popup-bottom .dx-toolbar-before .dx-button-today {
  float: left;
  margin-left: 5px;
}
.dx-datebox-wrapper .dx-popup-bottom .dx-toolbar-before .dx-button-today .dx-button-content {
  background: url(data:image/png;base64,) 50% 50% no-repeat;
  background-size: 19px 19px;
}
.dx-datebox-wrapper .dx-popup-bottom .dx-toolbar-after {
  right: auto;
  left: 0;
  width: 70%;
  margin-left: 15%;
...
.dx-datebox-wrapper .dx-popup-bottom .dx-toolbar-after .dx-toolbar-item {
  width: 50%;
}
.dx-datebox-wrapper .dx-popup-bottom .dx-toolbar-button .dx-button {
  margin-bottom: 5px;
  padding: 0;
  border-width: 2px;
  min-width: 0;
...
.dx-datebox-wrapper .dx-popup-bottom .dx-toolbar-button .dx-button .dx-button-text {
  display: none;
}
.dx-datebox-wrapper .dx-popup-bottom .dx-popup-done {
  float: right;
  margin-right: 5px;
}
.dx-datebox-wrapper .dx-popup-bottom .dx-popup-done .dx-button-content {
  background: url(data:image/png;base64,) 50% 50% no-repeat;
  background-size: 19px 19px;
}
.dx-datebox-wrapper .dx-popup-bottom .dx-popup-cancel {
  float: left;
  margin-left: 5px;
}
.dx-datebox-wrapper .dx-popup-bottom .dx-popup-cancel .dx-button-content {
  background: url(data:image/png;base64,) 50% 50% no-repeat;
  background-size: 19px 19px;
}
.dx-datebox-wrapper .dx-rtl .dx-popup-bottom .dx-popup-done,
.dx-datebox-wrapper .dx-rtl .dx-popup-bottom .dx-popup-done {
  float: left;
  margin-left: 5px;
  margin-right: 0;
}
.dx-datebox-wrapper .dx-rtl .dx-popup-bottom .dx-popup-cancel,
.dx-datebox-wrapper .dx-rtl .dx-popup-bottom .dx-popup-cancel {
  float: right;
  margin-left: 0;
  margin-right: 5px;
...
.dx-datebox-wrapper-calendar.dx-datebox-wrapper-datetime .dx-datebox-container-cell .dx-button {
  border-color: #00b8ff;
  background-color: #00b8ff;
  width: 106px;
}
.dx-datebox-wrapper-calendar.dx-datebox-wrapper-datetime .dx-datebox-container-cell .dx-button-text {
  color: #ffffff;
}
.dx-rtl .dx-calendar-with-time-picker .dx-datebox-calendar-container {
  margin-left: 0;
  margin-right: 30px;
}
.dx-dateview-rollers {
...
.dx-dateviewroller.dx-dateviewroller-current .dx-dateview-item-selected-frame {
  display: none;
}
.dx-dateviewroller.dx-state-active .dx-dateview-item.dx-dateview-item-selected {
  border-color: #a6a6a6;
  background-color: transparent;
  color: #a6a6a6;
}
.dx-dateviewroller .dx-scrollable-scrollbar {
  display: none;
}
...
.dx-dateview-item.dx-dateview-item-selected {
  border-color: #00b8ff;
  background-color: #00b8ff;
  color: #ffffff;
}
.dx-dateview-formatter-container {
  display: table;
  padding-top: 29px;
  line-height: 20px;
}
.dx-dateview-formatter-container .dx-dateview-value-formatter,
.dx-dateview-formatter-container .dx-dateview-name-formatter {
  display: table-row;
}
.dx-dateview-name-formatter {
  font-weight: 100;
  font-size: 12px;
}
.dx-device-phone .dx-dateview-datetime .dx-dateview-item {
  width: 64px;
}
.dx-device-phone .dx-dateview-datetime .dx-dateviewroller-hours .dx-dateview-item,
.dx-device-phone .dx-dateview-datetime .dx-dateviewroller-minutes .dx-dateview-item {
  width: 54px;
}
.dx-device-phone .dx-dateview-datetime .dx-dateviewroller-year .dx-dateview-item,
.dx-device-phone .dx-dateview-datetime .dx-dateviewroller-month .dx-dateview-item,
.dx-device-phone .dx-dateview-datetime .dx-dateviewroller-day .dx-dateview-item {
  padding: 0;
}
.dx-device-phone .dx-dateview-datetime .dx-dateviewroller-year .dx-dateview-value-formatter,
.dx-device-phone .dx-dateview-datetime .dx-dateviewroller-month .dx-dateview-value-formatter,
.dx-device-phone .dx-dateview-datetime .dx-dateviewroller-day .dx-dateview-value-formatter {
  text-indent: 5px;
}
.dx-rtl .dx-dateview-item {
  padding-left: 0;
  padding-right: 5px;
  text-align: right;
}
...
.dx-toolbar .dx-overlay-content {
  background: #ffffff;
  overflow: visible;
}
.dx-toolbar .dx-overlay-content .dx-toolbar-items-container {
  overflow: visible;
  height: 88px;
}
.dx-toolbar .dx-overlay-content .dx-toolbar-menu-container {
  padding: 0 5px 0 5px;
  vertical-align: auto;
  line-height: 0;
}
.dx-toolbar .dx-overlay-content .dx-toolbar-menu-button.dx-button {
  padding: 0;
  height: 100%;
  border: none;
}
.dx-toolbar .dx-overlay-content .dx-toolbar-menu-button .dx-button-content {
  overflow: visible;
}
.dx-toolbar .dx-overlay-content .dx-toolbar-menu-button .dx-button-text {
  padding: 0 5px;
  height: 88px;
  font-size: 250%;
  line-height: 0;
...
.dx-toolbar-mini .dx-toolbar-items-container {
  height: 40px;
}
.dx-toolbar-item {
  padding: 0 9px;
...
.dx-toolbar-item .dx-button-danger,
.dx-toolbar-item .dx-button-success {
  background: none;
}
...
.dx-toolbar-button,
.dx-toolbar .dx-dropdownmenu-button {
  padding: 0 9px;
}
.dx-toolbar-button .dx-icon,
.dx-toolbar .dx-dropdownmenu-button .dx-icon {
...
.dx-toolbar-button .dx-button-has-icon.dx-state-active,
.dx-toolbar .dx-dropdownmenu-button .dx-button-has-icon.dx-state-active {
  background: none;
}
.dx-toolbar-button .dx-button-has-icon.dx-state-active .dx-icon,
.dx-toolbar .dx-dropdownmenu-button .dx-button-has-icon.dx-state-active .dx-icon {
  background-color: #00b8ff;
}
.dx-toolbar-button .dx-button-has-icon.dx-state-hover,
.dx-toolbar .dx-dropdownmenu-button .dx-button-has-icon.dx-state-hover {
  background: none;
}
.dx-toolbar-button .dx-button-has-icon.dx-state-hover .dx-icon,
.dx-toolbar .dx-dropdownmenu-button .dx-button-has-icon.dx-state-hover .dx-icon {
  background-color: #2bb0ca;
}
.dx-toolbar-button .dx-button-has-icon.dx-state-focused,
.dx-toolbar .dx-dropdownmenu-button .dx-button-has-icon.dx-state-focused {
  background: none;
}
.dx-toolbar-button .dx-button-has-icon.dx-state-focused .dx-icon,
.dx-toolbar .dx-dropdownmenu-button .dx-button-has-icon.dx-state-focused .dx-icon {
  background-color: #80dbff;
}
.dx-toolbar-button .dx-button,
.dx-toolbar .dx-dropdownmenu-button .dx-button {
  padding: 4px;
  border: none;
}
.dx-toolbar-button .dx-button-text,
.dx-toolbar .dx-dropdownmenu-button .dx-button-text {
  line-height: 24px;
  font-size: 12px;
  font-weight: 400;
...
.dx-device-phone .dx-toolbar {
  height: 60px;
  background: #ffffff;
  line-height: 60px;
  opacity: 1;
}
.dx-device-phone .dx-toolbar.dx-toolbar-bottom {
  height: 40px;
}
.dx-device-phone .dx-toolbar.dx-toolbar-bottom .dx-overlay-wrapper .dx-toolbar-items-container {
  height: 60px;
}
.dx-device-phone .dx-toolbar.dx-toolbar-bottom .dx-overlay-wrapper .dx-toolbar-menu-button .dx-button-text {
  padding: 0 5px;
  height: 60px;
  font-size: 150%;
  font-weight: 600;
}
.dx-device-phone .dx-toolbar .dx-toolbar-item {
  padding: 0 3px;
}
.dx-device-phone .dx-toolbar .dx-toolbar-item.dx-toolbar-button .dx-button .dx-button-text {
  line-height: 20px;
  font-size: 8pt;
  font-weight: 600;
  text-transform: lowercase;
}
.dx-device-phone .dx-toolbar .dx-toolbar-button,
.dx-device-phone .dx-toolbar .dx-dropdownmenu-button {
  padding: 0 4px;
}
.dx-device-phone .dx-toolbar .dx-toolbar-button .dx-icon,
.dx-device-phone .dx-toolbar .dx-dropdownmenu-button .dx-icon {
  width: 32px;
  height: 32px;
...
.dx-device-phone .dx-toolbar .dx-toolbar-label {
  font-size: 20pt;
}
.dx-device-phone .dx-toolbar-after .dx-lookup-clear.dx-button {
  border: none;
}
.dx-device-phone .dx-toolbar-mini {
  line-height: 40px;
}
...
.dx-popup-wrapper .dx-button-has-icon {
  min-width: 0;
}
.dx-popup-fullscreen {
  padding: 0;
}
.dx-popup-fullscreen-width .dx-popup-title {
  margin: 0 20%;
}
.dx-popup-fullscreen-width .dx-popup-title.dx-toolbar {
  width: 60%;
}
.dx-popup-fullscreen-width .dx-popup-content {
  margin: 0 20%;
}
.dx-popup-fullscreen-width .dx-popup-bottom {
  margin: 0 20%;
}
.dx-popup-fullscreen-width .dx-popup-bottom.dx-toolbar {
  width: 60%;
}
...
.dx-popup-title .dx-closebutton.dx-state-focused .dx-icon {
  background-color: #80dbff;
}
...
.dx-popup-bottom .dx-toolbar-button .dx-button .dx-button-text {
  display: inline;
  line-height: 28px;
}
.dx-popup-bottom .dx-toolbar-button .dx-button.dx-state-active {
  background: #00b8ff;
}
.dx-popup-cancel-visible .dx-popup-content,
.dx-popup-clear-visible .dx-popup-content,
.dx-popup-done-visible .dx-popup-content {
  bottom: 60px;
}
...
.dx-dialog .dx-rtl .dx-toolbar-center {
  float: left;
}
...
.dx-dialog-root .dx-popup-title .dx-toolbar-label {
  font-weight: 600;
  font-size: 150%;
  line-height: 29px;
}
.dx-device-phone .dx-popup-title,
.dx-device-phone .dx-popup-content,
.dx-device-phone .dx-popup-bottom {
  margin: 0;
}
.dx-device-phone .dx-popup-title.dx-toolbar,
.dx-device-phone .dx-popup-bottom.dx-toolbar {
  width: 100%;
  background: none;
}
.dx-device-phone .dx-popup-bottom.dx-toolbar .dx-toolbar-button .dx-button .dx-button-text {
  line-height: 28px;
}
.dx-device-phone .dx-dialog-root .dx-overlay-content {
  width: 100% !important;
}
.dx-device-phone .dx-dialog-message {
  padding-top: 15px;
}
.dx-device-phone .dx-popup-title .dx-toolbar-label {
  padding: 0;
}
.dx-rtl .dx-toolbar-item.dx-toolbar-button {
  margin-left: 5px;
  margin-right: 0;
}
...
.dx-popover-wrapper .dx-overlay-content.dx-popover-fullscreen {
  padding: 0;
}
...
.dx-popover-wrapper .dx-popup-title .dx-toolbar-item {
  padding: 0;
}
.dx-popover-wrapper .dx-popup-title .dx-toolbar-label > div {
  padding: 0;
  margin: 0;
}
...
.dx-state-disabled.dx-progressbar .dx-progressbar-range {
  background-color: gray;
}
...
.dx-lookup-popup-wrapper .dx-popup-fullscreen {
  margin: 0;
  padding: 0;
}
.dx-lookup-popup-wrapper .dx-popup-fullscreen .dx-popup-content {
  margin: 0;
}
.dx-lookup-popup-wrapper .dx-popup-fullscreen .dx-popup-content .dx-lookup-search {
  padding: 0 10px;
}
...
.dx-lookup-popup-wrapper .dx-rtl .dx-list {
  margin-right: 0;
  margin-left: 8px;
}
.dx-lookup-popup-wrapper.dx-popover-wrapper .dx-list {
  margin-top: 0;
}
...
.dx-lookup-search-wrapper .dx-list {
  height: calc(100%);
}
.dx-lookup-search-wrapper .dx-texteditor-container {
  margin: 0;
}
@media screen and (orientation: portrait) {
  ...
  .dx-lookup-popup-wrapper .dx-overlay-content:not(.dx-popup-fullscreen) {
    padding: 0;
  }
}
...
.dx-invalid.dx-lookup.dx-state-focused .dx-lookup-field {
  border-color: #EA4444;
}
.dx-lookup-arrow {
  width: 34px;
...
.dx-actionsheet-popup-wrapper .dx-popup-content .dx-button.dx-state-active,
.dx-actionsheet-popover-wrapper .dx-popup-content .dx-button.dx-state-active {
  -webkit-transform: translate(2px, 2px);
          transform: translate(2px, 2px);
}
.dx-actionsheet-popup-wrapper .dx-popup-content .dx-button-text,
.dx-actionsheet-popover-wrapper .dx-popup-content .dx-button-text {
  font-weight: 200;
}
...
.dx-actionsheet-popup-wrapper .dx-toolbar {
  height: 40px;
}
.dx-actionsheet-popup-wrapper .dx-toolbar-item {
  padding: 0;
  margin: 0;
}
.dx-actionsheet-popup-wrapper .dx-popup-title {
...
.dx-actionsheet-container .dx-item-content {
  margin-bottom: 5px;
}
.dx-device-phone .dx-actionsheet-popup-wrapper .dx-popup-title {
  padding-left: 13px;
}
.dx-device-phone .dx-actionsheet-popup-wrapper .dx-popup-title .dx-toolbar-item-content {
  font-size: 16pt;
}
.dx-device-phone .dx-actionsheet-popup-wrapper .dx-popup-content .dx-button {
  font-size: 14pt;
}
.dx-device-phone .dx-actionsheet-popover-wrapper .dx-toolbar-item-content {
  font-size: 14pt;
}
...
.dx-loadindicator-segment {
  ...
  -webkit-animation: dx-win-loadindicator-orbit 4.95s infinite;
...
.dx-loadindicator-segment.dx-loadindicator-segment0 {
...
.dx-dropdownmenu-popup-wrapper .dx-overlay-content .dx-popup-content .dx-list-item.dx-state-active .dx-list-item-content {
  padding: 9px 9px 7px;
}
.dx-dropdownmenu-popup-wrapper .dx-overlay-content .dx-popup-content .dx-list-item-content {
  padding: 8px;
}
.dx-dropdownmenu-popup-wrapper.dx-popover-wrapper .dx-overlay-content {
  background-color: transparent;
}
.dx-dropdownmenu-popup-wrapper.dx-popover-wrapper .dx-popover-arrow:after {
  background-color: #000;
}
.dx-dropdowneditor.dx-selectbox .dx-dropdowneditor-button {
  display: none;
}
.dx-dropdowneditor.dx-selectbox .dx-texteditor-input {
  padding-right: 0.3em;
}
...
.dx-rtl .dx-dropdowneditor.dx-selectbox .dx-texteditor-input,
.dx-rtl.dx-dropdowneditor.dx-selectbox .dx-texteditor-input {
  padding-left: 0.3em;
}
...
.dx-tagbox .dx-texteditor-input:focus {
  border: none;
  background: none;
}
...
.dx-rtl .dx-dropdowneditor.dx-tagbox .dx-tag-content,
.dx-rtl.dx-dropdowneditor.dx-tagbox .dx-tag-content {
  padding-right: 6px;
  padding-left: 28px;
}
...
.dx-state-focused.dx-radiobutton .dx-radiobutton-icon:before {
  background-color: #ffffff;
  -webkit-box-shadow: inset #9c9c9c 0 0 3px;
          box-shadow: inset #9c9c9c 0 0 3px;
}
...
.dx-rtl .dx-radiobutton-checked .dx-radiobutton-icon .dx-radiobutton-icon-dot,
.dx-rtl.dx-radiobutton-checked .dx-radiobutton-icon .dx-radiobutton-icon-dot {
  margin-right: 4px;
  margin-left: 0;
}
...
.dx-colorview-container label input {
  border-radius: 0;
}
.dx-colorview-color-preview-container {
  margin-bottom: 34px;
...
.dx-datagrid .dx-menu .dx-menu-item-content .dx-icon {
  margin: 0px 4px;
}
...
.dx-datagrid-filter-range-overlay .dx-overlay-content .dx-editor-container.dx-highlight-outline::after {
  border-color: rgba(24, 167, 90, 0.4);
  left: 0px;
}
...
.dx-datagrid-filter-range-overlay .dx-overlay-content .dx-texteditor:not(.dx-state-focused) .dx-placeholder,
.dx-datagrid-filter-range-overlay .dx-overlay-content .dx-texteditor:not(.dx-state-focused) .dx-texteditor-input {
  color: #000;
}
...
.dx-datagrid-headers .dx-datagrid-table .dx-row:first-child {
  font-size: 12pt;
}
...
.dx-datagrid-header-panel .dx-button.dx-button-has-text {
  padding-top: 2px;
  padding-bottom: 2px;
}
.dx-datagrid-header-panel .dx-button.dx-button-has-text .dx-button-text {
  line-height: 25px;
}
...
.dx-datagrid-rowsview .dx-item-modified {
  outline: 2px solid rgba(24, 167, 90, 0.4);
}
.dx-datagrid-rowsview .dx-row-removed > td {
  background-color: rgba(24, 167, 90, 0.4);
  border-top: 1px solid rgba(24, 167, 90, 0.4);
  border-bottom: 1px solid rgba(24, 167, 90, 0.4);
}
...
.dx-datagrid-revert-tooltip .dx-revert-button.dx-state-focused {
  background-color: rgba(234, 68, 68, 0.5);
}
...
.dx-rtl .dx-datagrid .dx-menu .dx-menu-item-content {
...
.dx-menu-base .dx-menu-item-has-text.dx-menu-item-has-icon .dx-icon {
...
.dx-menu-base .dx-menu-item-selected > .dx-menu-item > .dx-menu-item-content {
  color: #000 !important;
}
...
.dx-menu .dx-menu-item-expanded .dx-menu-item-text {
  background-color: #00b8ff;
  color: #000;
}
...
.dx-menu .dx-menu-item-content .dx-menu-item-text {
  padding-left: 2px;
  padding-right: 2px;
  padding-top: 0px;
}
...
.dx-menu .dx-state-focused .dx-menu-item-text,
.dx-menu .dx-state-focused .dx-icon {
  color: #000;
}
...
.dx-menu-adaptive-mode.dx-overlay-content .dx-treeview-toggle-item-visibility {
  color: #000;
  width: 33px;
}
...
.dx-context-menu .dx-menu-item.dx-menu-item-expanded,
.dx-context-menu .dx-menu-item.dx-state-active {
  background-color: #00b8ff;
}
.dx-context-menu .dx-menu-item.dx-state-focused > .dx-menu-item-content,
.dx-context-menu .dx-menu-item.dx-menu-item-expanded > .dx-menu-item-content,
.dx-context-menu .dx-menu-item.dx-state-active > .dx-menu-item-content {
  color: #000;
}
.dx-context-menu .dx-menu-item-selected,
.dx-context-menu .dx-menu-item-selected.dx-state-focused {
  background-color: #80dbff;
}
.dx-context-menu .dx-menu-item-selected.dx-menu-item > .dx-menu-item-content,
.dx-context-menu .dx-menu-item-selected.dx-state-focused.dx-menu-item > .dx-menu-item-content {
  color: #000;
}
...
.dx-context-menu.dx-rtl .dx-menu-item-content .dx-menu-item-popout-container {
  margin-left: 0px;
  margin-right: auto;
}
.dx-context-menu.dx-rtl .dx-menu-item-content .dx-menu-item-popout-container .dx-menu-item-popout {
  -webkit-transform: scaleX(-1);
          transform: scaleX(-1);
}
.dx-calendar {
...
.dx-calendar-navigator .dx-calendar-caption-button.dx-state-hover .dx-button-text {
  color: #4dcdff;
}
.dx-calendar-navigator .dx-calendar-caption-button.dx-state-active {
  background-color: transparent;
}
.dx-calendar-navigator .dx-calendar-caption-button.dx-state-active .dx-button-text {
  color: rgba(0, 184, 255, 0.6);
}
.dx-calendar-navigator .dx-calendar-caption-button.dx-rtl,
.dx-rtl .dx-calendar-navigator .dx-calendar-caption-button {
  text-align: right;
}
...
.dx-calendar-navigator .dx-state-hover.dx-button {
  background-color: transparent;
}
.dx-calendar-navigator .dx-button:before {
  -webkit-box-sizing: content-box;
          box-sizing: content-box;
}
...
.dx-calendar-navigator-previous-view .dx-button-content .dx-icon,
.dx-calendar-navigator-next-view .dx-button-content .dx-icon {
  display: none;
}
...
.dx-calendar-navigator-previous-view:before,
.dx-calendar-navigator-next-view:before {
  position: absolute;
  top: 50%;
  left: 50%;
  display: block;
...
.dx-calendar-navigator-previous-view:after,
.dx-calendar-navigator-next-view:after {
  position: absolute;
  top: 50%;
  left: 50%;
  display: block;
...
.dx-calendar-navigator-next-view.dx-state-active:before,
.dx-calendar-navigator-previous-view.dx-state-active:before,
.dx-calendar-cell.dx-state-active:not(.dx-calendar-empty-cell) {
  background: rgba(0, 184, 255, 0.6);
}
.dx-calendar-navigator-next-view.dx-state-hover:before,
.dx-calendar-navigator-previous-view.dx-state-hover:before {
  background: #00b8ff;
}
...
.dx-calendar-view-month .dx-calendar-body th {
  padding-bottom: 1px;
}
.dx-calendar-view-month .dx-calendar-body th,
.dx-calendar-view-month .dx-calendar-body td {
  font-size: 12pt;
}
.dx-calendar-view-year td,
.dx-calendar-view-decade td {
  font-size: 15pt;
}
...
td.dx-calendar-contoured-date {
  border: 1px double #00b8ff;
}
td.dx-calendar-other-view {
  color: #bababa;
}
.dx-invalid .dx-calendar-body td {
  border-color: rgba(234, 68, 68, 0.4);
}
.dx-invalid.dx-state-focused .dx-calendar-body td {
  border-color: #EA4444;
}
.dx-treeview-node-loadindicator {
  top: 10px;
...
.dx-field-value:not(.dx-checkbox) {
  padding-top: 5px;
  padding-bottom: 9px;
}
...
.dx-field-value:not(.dx-checkbox):not(.dx-switch):not(.dx-button) {
  width: 100%;
}
...
.dx-edit-mode .dx-field-label {
  float: none;
}
.dx-edit-mode .dx-field-value {
  float: none;
  max-width: 300px;
}
.dx-fieldset-readonly .dx-field-label {
  color: #000;
  font-size: 20pt;
  text-transform: lowercase;
}
.dx-fieldset-readonly .dx-field-value {
  color: #888;
  font-size: 11pt;
}
.dx-device-phone .dx-fieldset-readonly .dx-field-label {
  font-size: 14pt;
}
.dx-device-phone .dx-fieldset-readonly .dx-field-value {
  font-size: 9pt;
}
.dx-device-phone .dx-field-value .dx-button-back .dx-button-content {
  line-height: 0;
}
