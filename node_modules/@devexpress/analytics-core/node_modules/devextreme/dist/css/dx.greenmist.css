...
.dx-colorview-hue-scale-handle {
  ...
  -webkit-box-shadow: inset -5px 0px 0px 3px #f5f5f5, inset 5px 0px 0px 3px #f5f5f5, inset -6px 0px 1px 4px rgba(0, 0, 0, 0.2), inset 6px 0px 1px 4px rgba(0, 0, 0, 0.2);
          box-shadow: inset -5px 0px 0px 3px #f5f5f5, inset 5px 0px 0px 3px #f5f5f5, inset -6px 0px 1px 4px rgba(0, 0, 0, 0.2), inset 6px 0px 1px 4px rgba(0, 0, 0, 0.2);
}
.dx-colorview-alpha-channel-handle {
  border: 1px solid rgba(0, 0, 0, 0.2);
  -webkit-box-shadow: inset 0px -5px 0px 3px #f5f5f5, inset 0px 5px 0px 3px #f5f5f5, inset 0px -6px 1px 4px rgba(0, 0, 0, 0.2), inset 0px 6px 1px 4px rgba(0, 0, 0, 0.2);
          box-shadow: inset 0px -5px 0px 3px #f5f5f5, inset 0px 5px 0px 3px #f5f5f5, inset 0px -6px 1px 4px rgba(0, 0, 0, 0.2), inset 0px 6px 1px 4px rgba(0, 0, 0, 0.2);
}
...
.dx-calendar-cell.dx-state-hover {
  -webkit-box-shadow: inset 0px -1px 0px 1000px #ebebeb;
          box-shadow: inset 0px -1px 0px 1000px #ebebeb;
  color: #28484f;
}
...
.dx-calendar-cell.dx-state-active:not(.dx-calendar-empty-cell):not(.dx-calendar-selected-date) {
  -webkit-box-shadow: inset 0px -1px 0px 1000px rgba(86, 86, 86, 0.2);
          box-shadow: inset 0px -1px 0px 1000px rgba(86, 86, 86, 0.2);
}
...
.dx-calendar-cell.dx-calendar-selected-date.dx-calendar-today {
  color: #fff;
  -webkit-box-shadow: inset 0px 0px 0px 1000px #3cbab2;
          box-shadow: inset 0px 0px 0px 1000px #3cbab2;
  font-weight: normal;
}
.dx-calendar-cell.dx-calendar-selected-date.dx-calendar-contoured-date,
.dx-calendar-cell.dx-calendar-selected-date.dx-calendar-today.dx-calendar-contoured-date {
  -webkit-box-shadow: inset 0px 0px 0px 1px #bfbfbf, inset 0px 0px 0px 1000px #3cbab2;
          box-shadow: inset 0px 0px 0px 1px #bfbfbf, inset 0px 0px 0px 1000px #3cbab2;
}
...
.dx-scheduler-appointment.dx-resizable-resizing {
  -webkit-box-shadow: inset 0px -2px 0px 0px rgba(0, 0, 0, 0.2), inset 0px 2px 0px 0px rgba(0, 0, 0, 0.2);
          box-shadow: inset 0px -2px 0px 0px rgba(0, 0, 0, 0.2), inset 0px 2px 0px 0px rgba(0, 0, 0, 0.2);
}
...
.dx-scheduler-appointment.dx-state-hover.dx-resizable {
  -webkit-box-shadow: inset 0px 5px 0px 0px rgba(0, 0, 0, 0.2), inset 0px -2px 0px 0px rgba(0, 0, 0, 0.2);
          box-shadow: inset 0px 5px 0px 0px rgba(0, 0, 0, 0.2), inset 0px -2px 0px 0px rgba(0, 0, 0, 0.2);
}
...
.dx-scheduler-appointment.dx-draggable-dragging {
  -webkit-box-shadow: 7px 7px 15px 0px rgba(50, 50, 50, 0.2), inset 0px -2px 0px 0px rgba(0, 0, 0, 0.2), inset 0px 2px 0px 0px rgba(0, 0, 0, 0.2);
          box-shadow: 7px 7px 15px 0px rgba(50, 50, 50, 0.2), inset 0px -2px 0px 0px rgba(0, 0, 0, 0.2), inset 0px 2px 0px 0px rgba(0, 0, 0, 0.2);
}
.dx-scheduler-appointment.dx-resizable-resizing,
.dx-scheduler-appointment.dx-draggable-dragging {
  z-index: 1000;
...
.dx-scheduler-all-day-appointment {
  -webkit-box-shadow: inset 2px 0px 0px 0px rgba(0, 0, 0, 0.2);
...
.dx-scheduler-all-day-appointment.dx-resizable-resizing {
  -webkit-box-shadow: inset -2px 0px 0px 0px rgba(0, 0, 0, 0.2), inset 2px 0px 0px 0px rgba(0, 0, 0, 0.2);
          box-shadow: inset -2px 0px 0px 0px rgba(0, 0, 0, 0.2), inset 2px 0px 0px 0px rgba(0, 0, 0, 0.2);
}
...
.dx-scheduler-all-day-appointment.dx-state-hover.dx-resizable {
  -webkit-box-shadow: inset 5px 0px 0px 0px rgba(0, 0, 0, 0.2), inset -2px 0px 0px 0px rgba(0, 0, 0, 0.2);
          box-shadow: inset 5px 0px 0px 0px rgba(0, 0, 0, 0.2), inset -2px 0px 0px 0px rgba(0, 0, 0, 0.2);
}
...
.dx-scheduler-all-day-appointment.dx-draggable-dragging {
  -webkit-box-shadow: inset -2px 0px 0px 0px rgba(0, 0, 0, 0.2), inset 2px 0px 0px 0px rgba(0, 0, 0, 0.2), 7px 7px 15px 0px rgba(50, 50, 50, 0.2);
          box-shadow: inset -2px 0px 0px 0px rgba(0, 0, 0, 0.2), inset 2px 0px 0px 0px rgba(0, 0, 0, 0.2), 7px 7px 15px 0px rgba(50, 50, 50, 0.2);
}
