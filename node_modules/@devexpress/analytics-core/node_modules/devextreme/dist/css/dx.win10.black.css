...
.dx-filterbuilder .dx-filterbuilder-group .dx-filterbuilder-text.dx-filterbuilder-item-operation:hover {
  background-color: #64c64d;
}
.dx-filterbuilder .dx-filterbuilder-group .dx-filterbuilder-text.dx-filterbuilder-item-operation:focus,
.dx-filterbuilder .dx-filterbuilder-group .dx-filterbuilder-text.dx-filterbuilder-item-operation.dx-state-active {
  background-color: #4da937;
  color: #FFF;
}
...
.dx-theme-win10-typography a {
  text-decoration: underline;
  color: #0078d7;
}
.dx-theme-win10-typography img {
  border-style: none;
}
.dx-theme-win10-typography h1,
.dx-theme-win10-typography .dx-font-xl {
  font-weight: 400;
  font-size: 46px;
  line-height: 56px;
}
.dx-theme-win10-typography h2,
.dx-theme-win10-typography .dx-font-l {
  font-weight: 200;
  font-size: 34px;
  line-height: 40px;
}
.dx-theme-win10-typography h3,
.dx-theme-win10-typography .dx-font-m {
  font-weight: 200;
  font-size: 24px;
  line-height: 28px;
}
.dx-theme-win10-typography h4 {
  font-weight: 200;
  font-size: 20px;
  line-height: 24px;
}
.dx-theme-win10-typography h5,
.dx-theme-win10-typography .dx-font-s {
  font-weight: 200;
  font-size: 15px;
  line-height: 20px;
}
.dx-theme-win10-typography h6,
.dx-theme-win10-typography small,
.dx-theme-win10-typography .dx-font-xs {
  font-weight: 200;
  font-size: 12px;
  line-height: 14px;
}
.dx-theme-win10-typography b,
.dx-theme-win10-typography strong {
  font-weight: 700;
}
.dx-theme-win10-typography.dx-device-phone h1,
.dx-theme-win10-typography.dx-device-phone .dx-font-xl {
  font-size: 32px;
}
.dx-theme-win10-typography.dx-device-phone h2,
.dx-theme-win10-typography.dx-device-phone .dx-font-l {
  font-size: 27px;
}
.dx-theme-win10-typography.dx-device-phone h3,
.dx-theme-win10-typography.dx-device-phone .dx-font-m {
  font-size: 24px;
}
.dx-theme-win10-typography.dx-device-phone h4,
.dx-theme-win10-typography.dx-device-phone .dx-font-s {
  font-size: 20px;
}
.dx-theme-win10-typography.dx-device-phone h5 {
  font-size: 15px;
}
.dx-theme-win10-typography.dx-device-phone h6,
.dx-theme-win10-typography.dx-device-phone small,
.dx-theme-win10-typography.dx-device-phone .dx-font-xs {
  font-size: 12px;
}
.dx-theme-marker {
  font-family: "dx.win10.black";
}
@font-face {
  font-family: 'DXIcons';
...
.dx-button-has-icon .dx-button-content,
.dx-button-has-icon.dx-button-back .dx-button-content {
  padding-left: 15px;
  padding-right: 15px;
}
.dx-button-has-text .dx-button-content {
...
.dx-button-has-icon.dx-button-has-text.dx-rtl .dx-button-text {
  padding-left: 0;
  padding-right: 8px;
}
...
.dx-state-hover.dx-button .dx-button-content,
.dx-state-focused.dx-button .dx-button-content {
  border-color: #999999;
}
.dx-button-danger {
  color: #fff;
}
.dx-button-danger .dx-button-content {
  background-color: #e81123;
  border-color: #e81123;
}
.dx-button-danger.dx-state-hover .dx-button-content {
  border-color: #9c0b18;
}
.dx-button-danger.dx-state-active .dx-button-content {
...
.dx-button-success .dx-button-content {
  background-color: #099f21;
  border-color: #099f21;
}
.dx-button-success.dx-state-hover .dx-button-content {
  border-color: #055211;
}
.dx-button-success.dx-state-active .dx-button-content {
  background-color: #043e0d;
  border-color: #043e0d;
}
.dx-button.dx-state-disabled,
.dx-button-danger.dx-state-disabled,
.dx-button-success.dx-state-disabled {
  color: #555555;
}
.dx-button.dx-state-disabled .dx-button-content,
.dx-button-danger.dx-state-disabled .dx-button-content,
.dx-button-success.dx-state-disabled .dx-button-content {
  background-color: #333333;
  border-color: #333333;
}
...
.dx-button-back .dx-icon-back:before {
  content: "\f011";
}
.dx-button-back.dx-rtl .dx-icon-back {
  font: 14px/1 DXIcons;
  width: 16px;
  height: 16px;
  background-position: 0px 0px;
...
.dx-button-back.dx-rtl .dx-icon-back:before {
  content: "\f00e";
}
...
.dx-checkbox-indeterminate .dx-checkbox-icon:after {
  content: '';
  display: block;
  height: 8px;
  width: 8px;
...
.dx-state-hover.dx-checkbox .dx-checkbox-icon,
.dx-state-focused.dx-checkbox .dx-checkbox-icon {
  border-color: #ffffff;
}
.dx-state-hover.dx-checkbox .dx-checkbox-icon:after,
.dx-state-focused.dx-checkbox .dx-checkbox-icon:after {
  border-color: #ffffff;
}
.dx-invalid.dx-checkbox .dx-checkbox-icon {
  border-color: #e81123;
}
...
.dx-state-disabled .dx-checkbox .dx-checkbox-icon:after,
.dx-state-disabled.dx-checkbox .dx-checkbox-icon:after {
  background-color: #000000;
  border-color: #555555;
}
...
.dx-tabs .dx-icon-chevronprev,
.dx-tabs .dx-icon-chevronnext {
  width: 28px;
  height: 28px;
  padding: 0;
  font-size: 18px;
...
.dx-tabs-nav-buttons .dx-tabs-nav-button .dx-button-content {
  border-width: 1px;
  border-color: transparent;
  padding-left: 0;
  padding-right: 0;
...
.dx-tabs-nav-buttons .dx-tabs-nav-button.dx-state-hover .dx-button-content,
.dx-tabs-nav-buttons .dx-tabs-nav-button.dx-state-focused .dx-button-content,
.dx-tabs-nav-buttons .dx-tabs-nav-button.dx-state-active .dx-button-content {
  border-color: #999999;
}
.dx-tabs-nav-buttons .dx-tabs-nav-button.dx-state-active .dx-button-content {
  background-color: #555555;
...
.dx-tabs.dx-state-disabled .dx-tab-content {
  color: #666666;
}
.dx-rtl .dx-tabs-item-badge {
  margin-left: -8px;
  margin-right: 2px;
}
.dx-rtl .dx-icon + .dx-tab-text {
  padding-left: 0;
  padding-right: 6px;
}
.dx-rtl .dx-tabs-nav-button-left {
  font: 14px/1 DXIcons;
}
.dx-rtl .dx-tabs-nav-button-left:before {
  content: "\f012";
}
.dx-rtl .dx-tabs-nav-button-right {
  font: 14px/1 DXIcons;
}
.dx-rtl .dx-tabs-nav-button-right:before {
  content: "\f010";
}
.dx-navbar {
  padding: 0 10px;
...
.dx-navbar .dx-tabs-wrapper {
  width: 100%;
  table-layout: fixed;
  display: table-row;
}
.dx-navbar.dx-tabs .dx-icon {
  width: 26px;
  height: 26px;
}
.dx-nav-item {
...
.dx-nav-item .dx-icon + .dx-tab-text {
  padding: 4px 0 0 0;
}
.dx-nav-item.dx-tab-selected {
  background-color: #1f1f1f;
  color: #0078d7;
  -webkit-box-shadow: inset 0 -3px 0 #0078d7;
          box-shadow: inset 0 -3px 0 #0078d7;
}
.dx-nav-item.dx-state-hover,
.dx-nav-item.dx-state-focused {
  background-color: #404040;
}
.dx-device-phone .dx-nav-item {
  padding-top: 17px;
  padding-bottom: 16px;
  font-size: 13px;
}
.dx-navbar-item-badge {
  ...
  margin-right: 0;
  margin-top: -32px;
  -webkit-box-shadow: 0 0 0 1px #1f1f1f;
          box-shadow: 0 0 0 1px #1f1f1f;
}
.dx-rtl.dx-navbar .dx-navbar-item-badge,
.dx-rtl .dx-navbar .dx-navbar-item-badge {
  right: 50%;
  left: auto;
}
.dx-state-disabled.dx-nav-item,
.dx-state-disabled .dx-nav-item {
  color: #666666;
}
...
.dx-texteditor .dx-texteditor-input a {
  text-decoration: underline;
  color: #0078d7;
}
.dx-texteditor .dx-texteditor-input img {
  border-style: none;
}
.dx-texteditor .dx-texteditor-input,
.dx-texteditor .dx-texteditor-input:hover {
  background-color: #000000;
  color: #fff;
}
.dx-texteditor .dx-texteditor-input::-ms-value {
  margin: 0;
}
.dx-texteditor.dx-show-clear-button .dx-texteditor-input {
  padding-right: 28px;
}
...
.dx-state-focused .dx-texteditor .dx-icon,
.dx-state-focused.dx-texteditor .dx-icon {
  color: #cccccc;
}
.dx-state-disabled .dx-texteditor .dx-icon,
.dx-state-disabled.dx-texteditor .dx-icon {
  color: #404040;
}
.dx-texteditor.dx-state-hover .dx-texteditor-container {
  border-color: #999999;
}
...
.dx-texteditor.dx-state-active .dx-texteditor-container {
  border-color: #0078d7;
}
...
.dx-state-disabled .dx-texteditor .dx-texteditor-container,
.dx-texteditor.dx-state-disabled .dx-texteditor-container {
  border-color: #2b2b2b;
...
.dx-invalid.dx-texteditor .dx-texteditor-container {
  border-color: #e81123;
}
...
.dx-clear-button-area .dx-icon-clear:before {
  content: "\f00a";
}
.dx-clear-button-area .dx-icon-clear:before {
  position: absolute;
...
.dx-dropdowneditor.dx-state-hover .dx-texteditor-container {
  border-color: #999999;
}
.dx-dropdowneditor.dx-state-focused .dx-texteditor-container {
  border-color: #0078d7;
}
.dx-dropdowneditor.dx-state-focused .dx-texteditor-input {
  background-color: #000000;
  color: #fff;
}
...
.dx-dropdowneditor.dx-state-active .dx-texteditor-input {
  background-color: #333333;
}
.dx-dropdowneditor.dx-state-active .dx-placeholder {
  color: #555555;
}
.dx-dropdowneditor.dx-invalid .dx-texteditor-container {
  border-color: #e81123;
}
...
.dx-rtl.dx-list-collapsible-groups .dx-list-group-header:before,
.dx-rtl .dx-list-collapsible-groups .dx-list-group-header:before {
  margin-right: 0;
  margin-left: 2px;
}
...
.dx-list-static-delete-button-container .dx-list-static-delete-button .dx-button-content {
  padding: 6px 7px;
}
.dx-list-static-delete-button-container .dx-list-static-delete-button .dx-icon-remove:before {
  content: "\f00a";
}
.dx-list-toggle-delete-switch-container {
  width: 42px;
}
.dx-list-toggle-delete-switch-container .dx-list-toggle-delete-switch {
  padding: 0;
  width: 100%;
  height: 40px;
}
.dx-list-toggle-delete-switch-container .dx-list-toggle-delete-switch .dx-button-content {
  padding: 0;
}
.dx-list-toggle-delete-switch-container .dx-list-toggle-delete-switch .dx-button-content,
.dx-list-toggle-delete-switch-container .dx-list-toggle-delete-switch.dx-state-active .dx-button-content {
  background: none;
  border: none;
}
.dx-list-toggle-delete-switch-container .dx-icon-toggle-delete {
  background-image: url(data:image/png;base64,);
...
.dx-list-reorder-handle {
  background-image: url(data:image/png;base64,iVBORw0KGgoAAAANSUhEUgAAAA0AAAAGCAQAAACyJdw0AAAAFUlEQVQY02PI/Y8LMuTihDSQwukMALk0Ox1oN0pRAAAAAElFTkSuQmCC);
  height: 40px;
}
...
.dx-rtl.dx-list-select-radiobutton-container,
.dx-rtl.dx-list-select-checkbox-container,
.dx-rtl .dx-list-select-radiobutton-container,
.dx-rtl .dx-list-select-checkbox-container {
  padding-right: 12px;
  padding-left: 0;
...
.dx-rtl.dx-list-select-all-checkbox,
.dx-rtl .dx-list-select-all-checkbox {
  float: right;
}
...
.dx-rtl.dx-list-select-all-label,
.dx-rtl .dx-list-select-all-label {
  padding-right: 13px;
  padding-left: 0;
}
...
.dx-state-disabled.dx-list .dx-list-item,
.dx-state-disabled .dx-list .dx-list-group-header,
.dx-state-disabled.dx-list .dx-list-group-header,
.dx-state-disabled .dx-list .dx-list-select-all-label,
.dx-state-disabled.dx-list .dx-list-select-all-label {
  color: #555555;
}
.dx-state-disabled .dx-list .dx-list-toggle-delete-switch,
.dx-state-disabled.dx-list .dx-list-toggle-delete-switch,
.dx-state-disabled .dx-list .dx-list-reorder-handle,
.dx-state-disabled.dx-list .dx-list-reorder-handle {
  opacity: 0.3;
}
...
.dx-rtl.dx-numberbox-spin-touch-friendly.dx-show-clear-button .dx-texteditor-input,
.dx-rtl .dx-numberbox-spin-touch-friendly.dx-show-clear-button .dx-texteditor-input {
  padding-right: 10px;
  padding-left: 106px;
}
...
.dx-datebox.dx-datebox-calendar .dx-dropdowneditor-icon {
  font: 14px/1 DXIcons;
  width: 18px;
  height: 18px;
  background-position: 0px 0px;
...
.dx-datebox.dx-datebox-calendar .dx-dropdowneditor-icon:before {
  content: "\f026";
}
.dx-datebox-calendar.dx-state-focused .dx-texteditor-container,
.dx-datebox-list.dx-state-focused .dx-texteditor-container,
.dx-datebox-native.dx-state-focused .dx-texteditor-container,
.dx-datebox-calendar.dx-state-active .dx-texteditor-container,
.dx-datebox-list.dx-state-active .dx-texteditor-container,
.dx-datebox-native.dx-state-active .dx-texteditor-container {
  border-color: #0078d7;
}
.dx-datebox-calendar.dx-state-focused .dx-texteditor-input,
.dx-datebox-list.dx-state-focused .dx-texteditor-input,
.dx-datebox-native.dx-state-focused .dx-texteditor-input,
.dx-datebox-calendar.dx-state-active .dx-texteditor-input,
.dx-datebox-list.dx-state-active .dx-texteditor-input,
.dx-datebox-native.dx-state-active .dx-texteditor-input {
  background-color: #ffffff;
  color: #000000;
}
.dx-datebox-wrapper .dx-calendar {
  background-color: #2b2b2b;
}
.dx-datebox-wrapper-rollers.dx-dropdowneditor-overlay .dx-overlay-content {
  border: 2px solid #555555;
}
.dx-datebox-wrapper-rollers .dx-popup-title {
  display: none;
}
.dx-datebox-wrapper-rollers .dx-popup-title.dx-toolbar {
  height: 0;
  min-height: 0;
}
.dx-datebox-wrapper-rollers .dx-popup-content {
  padding: 0;
}
.dx-datebox-wrapper-rollers .dx-popup-bottom {
  height: 34px;
  padding: 0;
  border-top: 2px solid rgba(255, 255, 255, 0.15);
}
.dx-datebox-wrapper-rollers .dx-popup-bottom .dx-toolbar-center {
  width: 100%;
}
.dx-datebox-wrapper-rollers .dx-popup-bottom .dx-toolbar-button {
  padding: 0;
}
.dx-datebox-wrapper-rollers .dx-popup-bottom .dx-toolbar-button .dx-button {
  width: 100%;
}
.dx-datebox-wrapper-rollers .dx-popup-bottom .dx-toolbar-button .dx-button .dx-button-content {
  background-color: #333333;
  border-color: #333333;
}
.dx-datebox-wrapper-rollers .dx-popup-bottom .dx-toolbar-button .dx-button.dx-state-hover .dx-button-content {
  background-color: #404040;
  border-color: #404040;
}
.dx-datebox-wrapper-rollers .dx-popup-bottom .dx-toolbar-button .dx-button.dx-state-active .dx-button-content {
  background-color: #555555;
  border-color: #555555;
}
.dx-datebox-wrapper-rollers .dx-popup-bottom .dx-toolbar-button .dx-popup-cancel,
.dx-datebox-wrapper-rollers .dx-popup-bottom .dx-toolbar-button .dx-popup-done {
  height: 32px;
}
.dx-datebox-wrapper-rollers .dx-popup-bottom .dx-toolbar-button .dx-popup-cancel .dx-button-text,
.dx-datebox-wrapper-rollers .dx-popup-bottom .dx-toolbar-button .dx-popup-done .dx-button-text {
  display: none;
}
.dx-datebox-wrapper-rollers .dx-popup-bottom .dx-toolbar-button .dx-popup-cancel .dx-button-content {
  font: 14px/1 DXIcons;
}
.dx-datebox-wrapper-rollers .dx-popup-bottom .dx-toolbar-button .dx-popup-cancel .dx-button-content:before {
  content: "\f00a";
}
.dx-datebox-wrapper-rollers .dx-popup-bottom .dx-toolbar-button .dx-popup-done .dx-button-content {
  font: 14px/1 DXIcons;
}
.dx-datebox-wrapper-rollers .dx-popup-bottom .dx-toolbar-button .dx-popup-done .dx-button-content:before {
  content: "\f005";
}
.dx-datebox-wrapper-rollers .dx-rtl.dx-overlay-content .dx-popup-bottom .dx-toolbar-button {
  padding: 0;
}
...
.dx-datebox-wrapper-calendar.dx-datebox-wrapper-datetime .dx-popup-bottom {
  padding-bottom: 5px;
}
.dx-datebox-wrapper-calendar.dx-datebox-wrapper-datetime .dx-rtl.dx-overlay-content .dx-popup-content {
  padding-left: 12px;
  padding-right: 37px;
  margin-bottom: -10px;
}
.dx-device-phone .dx-datebox-wrapper .dx-dateview {
  width: 100%;
}
.dx-dateview {
  height: 324px;
...
.dx-dateview.dx-state-disabled {
  color: #999999;
}
.dx-dateview.dx-state-disabled .dx-dateview-rollers:before {
  background-color: #666666;
}
.dx-dateview .dx-scrollable-content:before,
.dx-dateview .dx-scrollable-content:after {
  display: block;
  height: 146px;
}
.dx-dateview-time {
...
.dx-dateviewroller + .dx-dateviewroller {
...
.dx-dateviewroller-month .dx-dateview-item {
  padding-left: 9%;
  text-align: left;
}
.dx-dateview.dx-rtl .dx-dateviewroller + .dx-dateviewroller {
  border-left: none;
  border-right: 2px solid rgba(255, 255, 255, 0.15);
}
.dx-dateview.dx-rtl .dx-dateviewroller-month .dx-dateview-item {
  margin-left: auto;
  margin-right: 9%;
  text-align: right;
}
...
.dx-toolbar-button .dx-button.dx-state-hover .dx-button-content,
.dx-toolbar-button .dx-button.dx-state-focused .dx-button-content {
  background-color: #404040;
}
.dx-toolbar-button .dx-button.dx-state-active .dx-button-content {
  background-color: #555555;
}
...
.dx-toolbar-button .dx-button-has-icon .dx-icon {
  width: 20px;
  height: 20px;
  background-position: 0px 0px;
...
.dx-toolbar-button .dx-button-text,
.dx-toolbar-button .dx-button-icon {
  display: block;
}
.dx-toolbar-button .dx-button-has-text.dx-button-has-icon.dx-button-back .dx-button-content {
  padding: 20px 4px;
}
.dx-toolbar-button .dx-button-has-text.dx-button-has-icon.dx-button-back .dx-button-text {
  display: none;
}
.dx-toolbar-button .dx-button-has-text.dx-button-has-icon .dx-button-content {
  padding: 12px 4px 8px;
}
.dx-toolbar-button .dx-button-has-text.dx-button-has-icon .dx-button-text {
  padding-top: 4px;
  padding-left: 0;
  font-size: 12px;
}
.dx-toolbar-button .dx-button-has-text.dx-button-has-icon.dx-rtl .dx-button-text {
  padding-right: 0;
}
.dx-toolbar-menu-button .dx-button-text {
  font-size: 28px;
  line-height: 0;
  letter-spacing: 1px;
}
...
.dx-toolbar-bottom .dx-toolbar-items-container {
  height: 60px;
  background-color: inherit;
}
.dx-toolbar-bottom .dx-button {
  height: 60px;
}
.dx-toolbar-bottom .dx-button-content {
  padding: 16px 4px 26px;
}
.dx-toolbar-bottom .dx-button-has-icon .dx-button-content {
  padding: 14px 4px 22px;
}
.dx-toolbar-bottom .dx-button-has-text.dx-button-has-icon .dx-button-content,
.dx-toolbar-bottom .dx-button-has-text.dx-button-has-icon.dx-button-back .dx-button-content {
  padding: 14px 4px 6px;
}
.dx-toolbar-bottom .dx-button-has-text.dx-button-has-icon .dx-button-text {
  padding-top: 4px;
  visibility: hidden;
}
.dx-toolbar-list-visible.dx-toolbar-bottom .dx-button-has-text.dx-button-has-icon .dx-button-text {
  visibility: visible;
}
.dx-toolbar-bottom .dx-toolbar-menu-button {
  width: 48px;
}
...
.dx-toolbar-text-auto-hide .dx-button.dx-button-has-icon .dx-button-content {
  padding: 20px 4px;
}
.dx-device-phone .dx-overlay-modal.dx-overlay-wrapper {
  position: absolute;
}
.dx-overlay-wrapper {
  color: #fff;
...
.dx-toast-info .dx-toast-icon {
  background-image: url(data:image/png;base64,);
}
.dx-toast-warning .dx-toast-icon {
  background-image: url(data:image/png;base64,);
}
.dx-toast-error .dx-toast-icon {
  background-image: url(data:image/png;base64,);
}
.dx-toast-success .dx-toast-icon {
  background-image: url(data:image/png;base64,);
}
...
.dx-rtl .dx-popup-title .dx-toolbar-label,
.dx-rtl.dx-popup-title .dx-toolbar-label {
  padding-right: 12px;
  padding-left: 0;
}
.dx-popup-title .dx-toolbar-button .dx-button {
  height: 29px;
  width: auto;
  min-width: 45px;
}
.dx-popup-title .dx-toolbar-button .dx-button-content {
  font-size: 12px;
}
.dx-popup-title .dx-toolbar-button .dx-button-text {
  display: inline;
  text-overflow: clip;
  padding-bottom: 0;
}
.dx-popup-title .dx-toolbar-button .dx-button-back .dx-button-content,
.dx-popup-title .dx-toolbar-button .dx-button-has-text .dx-button-content,
.dx-popup-title .dx-toolbar-button .dx-button-has-icon .dx-button-content,
.dx-popup-title .dx-toolbar-button .dx-button-has-icon.dx-button-has-text .dx-button-content {
  padding: 6px;
}
.dx-popup-title .dx-toolbar-button .dx-button-has-icon.dx-button-has-text .dx-button-text {
  padding-left: 6px;
}
.dx-rtl .dx-popup-title .dx-toolbar-button .dx-button-has-icon.dx-button-has-text .dx-button-text,
.dx-rtl.dx-popup-title .dx-toolbar-button .dx-button-has-icon.dx-button-has-text .dx-button-text {
  padding-right: 6px;
  padding-left: 0;
}
.dx-popup-title .dx-toolbar-button .dx-icon {
  width: 14px;
  height: 100%;
  font-size: 14px;
  text-align: center;
...
.dx-popup-title .dx-toolbar-button .dx-icon:before {
  position: absolute;
  display: block;
  width: 14px;
  top: 50%;
...
.dx-popup-title .dx-toolbar-button .dx-closebutton.dx-state-hover .dx-button-content {
  background-color: #e81123;
  color: #fff;
}
.dx-popup-title .dx-toolbar-button .dx-closebutton.dx-state-active .dx-button-content {
  background-color: #f16e77;
}
.dx-popup-content {
  padding: 12px;
...
.dx-popup-bottom .dx-toolbar-button:first-child {
  padding-left: 0;
}
.dx-rtl .dx-popup-bottom .dx-toolbar-button:first-child,
.dx-rtl.dx-popup-bottom .dx-toolbar-button:first-child {
  padding-right: 0;
  padding-left: 6px;
}
.dx-popup-bottom .dx-toolbar-button:last-child {
  padding-right: 0;
}
.dx-rtl .dx-popup-bottom .dx-toolbar-button:last-child,
.dx-rtl.dx-popup-bottom .dx-toolbar-button:last-child {
  padding-right: 6px;
  padding-left: 0;
}
...
.dx-popup-bottom .dx-toolbar-button .dx-button-text {
  display: inline;
  text-overflow: clip;
}
.dx-popup-bottom .dx-toolbar-button .dx-button-content {
  line-height: 16px;
  padding: 6px 15px 6px;
  border: 2px solid #333333;
  background-color: #333333;
}
.dx-popup-bottom .dx-toolbar-button .dx-button-has-icon .dx-button-content,
.dx-popup-bottom .dx-toolbar-button .dx-button-has-text .dx-button-content {
  line-height: 0;
}
.dx-popup-bottom .dx-toolbar-button .dx-button-has-icon .dx-button-content,
.dx-popup-bottom .dx-toolbar-button .dx-button-has-icon.dx-button-back .dx-button-content {
  padding-left: 15px;
  padding-right: 15px;
}
.dx-popup-bottom .dx-toolbar-button .dx-button-has-text .dx-button-content {
...
.dx-popup-bottom .dx-toolbar-button .dx-button-has-icon.dx-button-has-text .dx-button-text {
  padding-left: 8px;
}
.dx-popup-bottom .dx-toolbar-button .dx-button-has-icon.dx-button-has-text.dx-rtl .dx-button-text {
  padding-left: 0;
  padding-right: 8px;
}
.dx-popup-bottom .dx-toolbar-button .dx-state-active.dx-button .dx-button-content {
  background-color: #666666;
  border-color: #666666;
}
.dx-popup-bottom .dx-toolbar-button .dx-state-hover.dx-button .dx-button-content,
.dx-popup-bottom .dx-toolbar-button .dx-state-focused.dx-button .dx-button-content {
  border-color: #999999;
}
.dx-popup-bottom .dx-toolbar-button .dx-button-danger {
  color: #fff;
}
.dx-popup-bottom .dx-toolbar-button .dx-button-danger .dx-button-content {
  background-color: #e81123;
  border-color: #e81123;
}
.dx-popup-bottom .dx-toolbar-button .dx-button-danger.dx-state-hover .dx-button-content {
  border-color: #9c0b18;
}
.dx-popup-bottom .dx-toolbar-button .dx-button-danger.dx-state-active .dx-button-content {
  background-color: #890a15;
  border-color: #890a15;
}
.dx-popup-bottom .dx-toolbar-button .dx-button-success {
  color: #fff;
}
.dx-popup-bottom .dx-toolbar-button .dx-button-success .dx-button-content {
  background-color: #099f21;
  border-color: #099f21;
}
.dx-popup-bottom .dx-toolbar-button .dx-button-success.dx-state-hover .dx-button-content {
  border-color: #055211;
}
.dx-popup-bottom .dx-toolbar-button .dx-button-success.dx-state-active .dx-button-content {
  background-color: #043e0d;
  border-color: #043e0d;
}
.dx-popup-bottom .dx-toolbar-button .dx-button.dx-state-disabled,
.dx-popup-bottom .dx-toolbar-button .dx-button-danger.dx-state-disabled,
.dx-popup-bottom .dx-toolbar-button .dx-button-success.dx-state-disabled {
  color: #555555;
}
.dx-popup-bottom .dx-toolbar-button .dx-button.dx-state-disabled .dx-button-content,
.dx-popup-bottom .dx-toolbar-button .dx-button-danger.dx-state-disabled .dx-button-content,
.dx-popup-bottom .dx-toolbar-button .dx-button-success.dx-state-disabled .dx-button-content {
  background-color: #333333;
  border-color: #333333;
}
.dx-popover-wrapper .dx-overlay-content .dx-popover-arrow {
  display: none;
  height: 4px;
  width: 4px;
}
.dx-popover-wrapper .dx-overlay-content .dx-popover-arrow:after {
  content: none;
}
.dx-popover-wrapper .dx-popup-title + .dx-popup-content {
  padding-top: 6px;
}
.dx-trackbar-wrapper {
  line-height: 16px;
}
.dx-trackbar-container {
  background-color: #999999;
}
.dx-trackbar-range {
  background-color: #0078d7;
}
.dx-state-disabled.dx-trackbar .dx-trackbar-range,
.dx-state-disabled.dx-trackbar .dx-trackbar-container {
  background-color: #2b2b2b;
}
...
.dx-state-disabled.dx-progressbar .dx-progressbar-container {
  background-color: #999999;
}
.dx-state-disabled.dx-progressbar .dx-progressbar-animating-segment {
  -webkit-animation: none;
          animation: none;
  background-color: #0078d7;
}
.dx-state-disabled.dx-progressbar .dx-progressbar-animating-segment-1 {
  left: 44%;
}
.dx-state-disabled.dx-progressbar .dx-progressbar-animating-segment-2 {
  left: 47%;
}
.dx-state-disabled.dx-progressbar .dx-progressbar-animating-segment-3 {
  left: 50%;
}
.dx-state-disabled.dx-progressbar .dx-progressbar-animating-segment-4 {
  left: 53%;
}
.dx-state-disabled.dx-progressbar .dx-progressbar-animating-segment-5 {
  left: 56%;
}
...
.dx-slider-handle.dx-rtl {
  left: -4px;
  right: auto;
}
.dx-slider-handle.dx-state-hover,
.dx-slider-handle.dx-state-focused {
  background-color: #666666;
}
.dx-slider-handle.dx-state-active {
  background-color: #cccccc;
}
.dx-slider-handle.dx-state-disabled,
.dx-state-disabled .dx-slider-handle {
  background-color: #2b2b2b;
}
.dx-slider-handle .dx-tooltip .dx-tooltip-wrapper .dx-popover-arrow {
  height: 20.5px;
}
.dx-slider-label {
  font-size: 11px;
...
.dx-gallery-nav-button-prev.dx-state-active:before,
.dx-gallery-nav-button-next.dx-state-active:before {
  color: #666666;
}
.dx-gallery-nav-button-prev.dx-state-hover:before,
.dx-gallery-nav-button-next.dx-state-hover:before {
  color: #999999;
}
.dx-gallery-nav-button-prev {
  font: 14px/1 DXIcons;
...
.dx-state-focused.dx-lookup-empty .dx-lookup-field {
  color: #999999;
}
.dx-lookup {
  height: 32px;
}
.dx-lookup.dx-state-hover .dx-lookup-field {
  border-color: #999999;
}
.dx-lookup.dx-state-focused .dx-lookup-field {
  border-color: #0078d7;
}
...
.dx-lookup.dx-state-active.dx-lookup-empty .dx-lookup-field {
  color: #555555;
}
.dx-state-disabled .dx-lookup .dx-lookup-field,
...
.dx-lookup.dx-state-disabled .dx-lookup-arrow {
  color: #555555;
}
.dx-invalid.dx-lookup .dx-lookup-field {
  border-color: #e81123;
}
...
.dx-actionsheet-popup-wrapper .dx-popup-content .dx-button.dx-state-hover .dx-button-content,
.dx-actionsheet-popover-wrapper .dx-popup-content .dx-button.dx-state-hover .dx-button-content {
  background-color: #404040;
}
.dx-actionsheet-popup-wrapper .dx-popup-content .dx-button.dx-state-active .dx-button-content,
.dx-actionsheet-popover-wrapper .dx-popup-content .dx-button.dx-state-active .dx-button-content {
  background-color: #555555;
}
...
.dx-actionsheet-popup-wrapper .dx-toolbar-label,
.dx-actionsheet-popover-wrapper .dx-toolbar-label {
  font-size: 16px;
  padding-top: 8px;
}
.dx-actionsheet-popup-wrapper .dx-overlay-content.dx-rtl .dx-button-content,
.dx-actionsheet-popover-wrapper .dx-overlay-content.dx-rtl .dx-button-content {
  text-align: right;
}
...
.dx-actionsheet-container .dx-button.dx-state-disabled,
.dx-state-disabled.dx-actionsheet-container .dx-button {
  color: #555555;
}
.dx-actionsheet-container .dx-button.dx-state-disabled .dx-button-content,
.dx-state-disabled.dx-actionsheet-container .dx-button .dx-button-content {
  background-color: transparent;
}
...
.dx-loadindicator-segment {
  ...
  -webkit-animation: dx-win-loadindicator-orbit 5s infinite;
          animation: dx-win-loadindicator-orbit 5s infinite;
}
.dx-loadindicator-segment:before {
  content: "";
  position: absolute;
  width: 17%;
  height: 17%;
...
.dx-loadindicator-segment.dx-loadindicator-segment1 {
  -webkit-animation-delay: 240ms;
          animation-delay: 240ms;
}
.dx-loadindicator-segment.dx-loadindicator-segment2 {
  -webkit-animation-delay: 480ms;
          animation-delay: 480ms;
}
.dx-loadindicator-segment.dx-loadindicator-segment3 {
  -webkit-animation-delay: 720ms;
          animation-delay: 720ms;
}
.dx-loadindicator-segment.dx-loadindicator-segment4 {
...
.dx-autocomplete.dx-state-focused .dx-texteditor-container,
.dx-autocomplete.dx-state-active .dx-texteditor-container {
  border-color: #0078d7;
}
.dx-autocomplete.dx-state-focused .dx-texteditor-input,
.dx-autocomplete.dx-state-active .dx-texteditor-input {
  background-color: #ffffff;
  color: #000000;
}
...
.dx-tagbox.dx-state-active .dx-tag-container {
  background-color: #333333;
}
.dx-tagbox .dx-selectbox-container {
  background-color: #000000;
}
...
.dx-tagbox-single-line.dx-state-active .dx-dropdowneditor-button {
  background-color: #333333;
}
...
.dx-state-disabled .dx-tagbox .dx-tag,
.dx-state-disabled.dx-tagbox .dx-tag {
  opacity: 1;
}
.dx-state-disabled .dx-tagbox .dx-tag-content,
.dx-state-disabled.dx-tagbox .dx-tag-content {
  background-color: #404040;
  color: #2b2b2b;
  padding-right: 6px;
}
.dx-state-disabled .dx-tagbox .dx-tag-remove-button,
.dx-state-disabled.dx-tagbox .dx-tag-remove-button {
  display: none;
}
...
.dx-rtl .dx-tagbox.dx-show-clear-button.dx-dropdowneditor-button-visible .dx-tag-container,
.dx-rtl.dx-tagbox.dx-show-clear-button.dx-dropdowneditor-button-visible .dx-tag-container {
  padding-right: 0;
  padding-left: 56px;
}
...
.dx-state-hover.dx-radiobutton .dx-radiobutton-icon,
.dx-state-focused.dx-radiobutton .dx-radiobutton-icon {
  border-color: #ffffff;
}
.dx-state-hover .dx-radiobutton-icon-checked,
.dx-state-focused .dx-radiobutton-icon-checked {
  border-color: #0078d7;
}
.dx-state-hover .dx-radiobutton-icon-checked .dx-radiobutton-icon-dot,
.dx-state-focused .dx-radiobutton-icon-checked .dx-radiobutton-icon-dot {
  background-color: #ffffff;
}
...
.dx-radiobutton.dx-invalid .dx-radiobutton-icon {
  border-color: #e81123;
}
...
.dx-radiogroup.dx-invalid .dx-radiobutton-icon {
  border-color: #e81123;
}
.dx-radiobutton {
  line-height: 18px;
}
.dx-radiogroup-vertical .dx-radiobutton {
  margin-bottom: 10px;
}
.dx-radiogroup-vertical .dx-radiobutton:last-of-type {
  margin-bottom: 0;
}
...
.dx-state-disabled.dx-pivottabs .dx-pivottabs-tab,
.dx-state-disabled .dx-pivottabs .dx-pivottabs-tab,
.dx-state-disabled.dx-pivottabs .dx-pivottabs-tab-selected,
.dx-state-disabled .dx-pivottabs .dx-pivottabs-tab-selected {
  color: #555555;
}
...
.dx-accordion-item.dx-state-hover.dx-accordion-item-opened > .dx-accordion-item-title,
.dx-accordion-item.dx-state-focused.dx-accordion-item-opened > .dx-accordion-item-title {
  background-color: #0969b5;
}
.dx-accordion-item.dx-state-active > .dx-accordion-item-title {
  background-color: #555555;
}
.dx-accordion-item.dx-state-active.dx-accordion-item-opened > .dx-accordion-item-title {
  background-color: #0472c9;
}
...
.dx-rtl.dx-accordion.dx-accordion-item-title .dx-icon,
.dx-rtl .dx-accordion .dx-accordion-item-title .dx-icon {
  margin-right: 0;
  margin-left: 12px;
}
.dx-rtl.dx-accordion.dx-accordion-item-title:before,
.dx-rtl .dx-accordion .dx-accordion-item-title:before {
  right: auto;
  left: 12px;
}
...
.dx-rtl .dx-colorview-color-preview-container {
  margin-right: 2px;
  margin-left: 0;
}
...
.dx-state-disabled .dx-colorview .dx-colorview-palette-cell,
.dx-state-disabled.dx-colorview .dx-colorview-palette-cell,
.dx-state-disabled .dx-colorview .dx-colorview-hue-scale-cell,
.dx-state-disabled.dx-colorview .dx-colorview-hue-scale-cell,
.dx-state-disabled .dx-colorview .dx-colorview-color-preview-container,
.dx-state-disabled.dx-colorview .dx-colorview-color-preview-container,
.dx-state-disabled .dx-colorview .dx-colorview-alpha-channel-cell,
.dx-state-disabled.dx-colorview .dx-colorview-alpha-channel-cell {
  opacity: 0.5;
}
...
.dx-colorbox.dx-state-focused .dx-texteditor-container,
.dx-colorbox.dx-state-active .dx-texteditor-container {
  border-color: #0078d7;
}
.dx-colorbox.dx-state-focused .dx-texteditor-input,
.dx-colorbox.dx-state-active .dx-texteditor-input {
  background-color: #ffffff;
  color: #000000;
}
...
.dx-rtl.dx-colorbox .dx-colorbox-input-container .dx-colorbox-input.dx-texteditor-input,
.dx-rtl .dx-colorbox .dx-colorbox-input-container .dx-colorbox-input.dx-texteditor-input {
  padding-right: 37px;
}
...
.dx-colorbox-color-is-not-defined .dx-colorbox-color-result-preview {
  background: url(data:image/png;base64,iVBORw0KGgoAAAANSUhEUgAAABEAAAARCAQAAACRZI9xAAAAc0lEQVQoz4XRwQ3AIAgFUCarCa7DuVs5WYewVLSASsyPHMwL+QlA9RTg8dBFsE2mIiQFKPM/CoEtEgCDrGgAQzxS4IgiCyYi6HZgIcCg8oOY5L4lRWR0SA4ZgqaDRT/BqaSiTmZgUSM7oKhfGoNLf6iRQ16a/+IUWMpnqQAAAABJRU5ErkJggg==) no-repeat 0 0;
}
.dx-colorbox-overlay {
  padding: 0;
}
...
.dx-datagrid-filter-range-overlay .dx-overlay-content .dx-editor-container .dx-texteditor-container {
  margin: 0px;
  border: 0px;
}
...
.dx-datagrid-filter-range-overlay .dx-overlay-content .dx-texteditor .dx-texteditor-input:not(:focus) {
  background-color: #000000;
}
.dx-datagrid-filter-range-overlay .dx-overlay-content .dx-texteditor.dx-state-focused:after {
  border: 2px solid #0078d7;
}
.dx-datagrid-filter-range-overlay .dx-overlay-content .dx-texteditor .dx-placeholder {
  padding-top: 7px;
}
...
.dx-datagrid .dx-menu-base .dx-menu-item.dx-menu-item-has-submenu .dx-menu-item-content {
  padding: 7px 12px;
}
.dx-datagrid .dx-menu {
  background-color: transparent;
...
.dx-datagrid .dx-editor-cell .dx-texteditor-input:focus {
  background: #404040;
  color: #fff;
}
.dx-datagrid .dx-editor-cell > .dx-checkbox {
  margin-top: -2px;
}
.dx-datagrid .dx-editor-cell .dx-numberbox-spin-up-icon,
.dx-datagrid .dx-editor-cell .dx-numberbox-spin-down-icon,
.dx-datagrid .dx-editor-cell .dx-dropdowneditor-icon {
  color: #fff;
}
.dx-datagrid .dx-editor-cell .dx-numberbox-spin .dx-texteditor-input {
  padding-right: 34px;
}
.dx-datagrid .dx-editor-cell .dx-numberbox-spin-touch-friendly .dx-texteditor-input {
  padding-right: 68px;
}
.dx-datagrid .dx-editor-cell .dx-timebox-date .dx-dropdowneditor-icon {
  color: #fff;
}
.dx-datagrid .dx-editor-cell.dx-focused .dx-numberbox-spin-up-icon,
.dx-datagrid .dx-editor-cell.dx-focused .dx-numberbox-spin-down-icon,
.dx-datagrid .dx-editor-cell.dx-focused .dx-dropdowneditor-icon {
  color: #000000;
}
.dx-datagrid .dx-editor-cell .dx-numberbox-spin-up-icon,
.dx-datagrid .dx-editor-cell .dx-numberbox-spin-down-icon,
.dx-datagrid .dx-editor-cell .dx-dropdowneditor-icon,
.dx-datagrid .dx-editor-cell .dx-lookup-field::before {
  opacity: 0.4;
}
...
.dx-rtl.dx-datagrid-headers .dx-dropdowneditor-button-visible.dx-show-clear-button .dx-texteditor-input,
.dx-rtl.dx-datagrid-rowsview .dx-dropdowneditor-button-visible.dx-show-clear-button .dx-texteditor-input,
.dx-rtl .dx-datagrid-headers .dx-dropdowneditor-button-visible.dx-show-clear-button .dx-texteditor-input,
.dx-rtl .dx-datagrid-rowsview .dx-dropdowneditor-button-visible.dx-show-clear-button .dx-texteditor-input {
  padding-right: 10px;
  padding-left: 66px;
...
.dx-datagrid-export-menu.dx-context-menu .dx-submenu > .dx-menu-items-container {
  background-color: #ffffff;
  border-color: #000000;
  color: #000000;
}
.dx-datagrid-export-menu.dx-context-menu .dx-menu-separator {
  background-color: #000000;
}
...
.dx-datagrid-column-chooser .dx-overlay-content .dx-popup-bottom .dx-toolbar-before {
  position: static;
  margin: 0 auto;
}
...
.dx-data-row.dx-state-hover:not(.dx-selection):not(.dx-row-inserted):not(.dx-row-removed):not(.dx-edit-row) > .dx-datagrid-readonly:not(.dx-focused) .dx-texteditor .dx-texteditor-input {
  text-shadow: none;
  background-color: #404040;
  color: #fff;
}
...
.dx-datagrid-header-panel .dx-toolbar-button:not(.dx-state-disabled) .dx-apply-:not(.dx-state-hover) .dx-button-content {
  background-color: #099f21;
}
...
.dx-datagrid-rowsview .dx-editor-cell .dx-icon-clear {
  left: 0px;
}
...
.dx-datagrid-rowsview .dx-adaptive-detail-row .dx-adaptive-item-text.dx-datagrid-invalid {
  border: 2px solid #e81123;
  padding-top: 7px;
  padding-bottom: 7px;
  padding-left: 7px;
}
.dx-datagrid-rowsview .dx-adaptive-detail-row .dx-item-modified {
  border: 2px solid #099f21;
}
.dx-datagrid-rowsview .dx-adaptive-detail-row .dx-item-modified.dx-adaptive-item-text {
  padding-top: 7px;
  padding-bottom: 7px;
  padding-left: 7px;
}
.dx-datagrid-rowsview .dx-row-removed > td {
  background-color: #099f21;
  border-top: 1px solid #099f21;
  border-bottom: 1px solid #099f21;
}
.dx-datagrid-rowsview .dx-selection .dx-focused {
  color: #fff;
}
...
.dx-datagrid-rowsview .dx-selection.dx-row > .dx-datagrid-readonly .dx-texteditor .dx-texteditor-input,
.dx-datagrid-rowsview .dx-selection.dx-row:hover > .dx-datagrid-readonly .dx-texteditor .dx-texteditor-input {
  background-color: #115a93;
}
...
.dx-datagrid-rowsview .dx-selection.dx-row > .dx-datagrid-readonly:not(.dx-focused) .dx-texteditor .dx-texteditor-input,
.dx-datagrid-rowsview .dx-selection.dx-row:hover > .dx-datagrid-readonly:not(.dx-focused) .dx-texteditor .dx-texteditor-input {
  background-color: transparent;
}
.dx-datagrid-rowsview .dx-selection.dx-row:not(.dx-row-lines),
.dx-datagrid-rowsview .dx-selection.dx-row:hover:not(.dx-row-lines) {
  border-bottom-color: #115a93;
}
...
.dx-datagrid-revert-tooltip .dx-revert-button.dx-state-hover .dx-button-content {
  border-color: #e81123;
}
.dx-datagrid-revert-tooltip .dx-revert-button.dx-state-focused .dx-button-content {
...
.dx-rtl .dx-editor-cell .dx-texteditor .dx-texteditor-input {
  padding-right: 7px;
}
.dx-rtl .dx-datagrid-rowsview .dx-selection > td:not(.dx-focused).dx-datagrid-group-space,
.dx-rtl .dx-datagrid-rowsview .dx-selection.dx-row:hover > td:not(.dx-focused).dx-datagrid-group-space,
.dx-rtl .dx-datagrid-rowsview .dx-selection tr > td:not(.dx-focused).dx-datagrid-group-space,
.dx-rtl .dx-datagrid-rowsview .dx-selection.dx-row:hover tr > td:not(.dx-focused).dx-datagrid-group-space {
  border-left-color: #115a93;
}
...
.dx-treelist-filter-range-overlay .dx-overlay-content .dx-editor-container .dx-texteditor-container {
  margin: 0px;
  border: 0px;
}
...
.dx-treelist-filter-range-overlay .dx-overlay-content .dx-texteditor .dx-texteditor-input:not(:focus) {
  background-color: #000000;
}
.dx-treelist-filter-range-overlay .dx-overlay-content .dx-texteditor.dx-state-focused:after {
  border: 2px solid #0078d7;
}
.dx-treelist-filter-range-overlay .dx-overlay-content .dx-texteditor .dx-placeholder {
  padding-top: 7px;
}
...
.dx-treelist .dx-menu-base .dx-menu-item.dx-menu-item-has-submenu .dx-menu-item-content {
  padding: 7px 12px;
}
.dx-treelist .dx-menu {
  background-color: transparent;
...
.dx-treelist .dx-editor-cell .dx-texteditor-input {
  margin: 0px;
  border: 0px;
  background: #000000;
  color: #fff;
...
.dx-treelist .dx-editor-cell .dx-texteditor-input:focus {
  background: #404040;
  color: #fff;
}
.dx-treelist .dx-editor-cell > .dx-checkbox {
  margin-top: -2px;
}
.dx-treelist .dx-editor-cell .dx-numberbox-spin-up-icon,
.dx-treelist .dx-editor-cell .dx-numberbox-spin-down-icon,
.dx-treelist .dx-editor-cell .dx-dropdowneditor-icon {
  color: #fff;
}
.dx-treelist .dx-editor-cell .dx-numberbox-spin .dx-texteditor-input {
  padding-right: 34px;
}
.dx-treelist .dx-editor-cell .dx-numberbox-spin-touch-friendly .dx-texteditor-input {
  padding-right: 68px;
}
.dx-treelist .dx-editor-cell .dx-timebox-date .dx-dropdowneditor-icon {
  color: #fff;
}
.dx-treelist .dx-editor-cell.dx-focused .dx-numberbox-spin-up-icon,
.dx-treelist .dx-editor-cell.dx-focused .dx-numberbox-spin-down-icon,
.dx-treelist .dx-editor-cell.dx-focused .dx-dropdowneditor-icon {
  color: #000000;
}
.dx-treelist .dx-editor-cell .dx-numberbox-spin-up-icon,
.dx-treelist .dx-editor-cell .dx-numberbox-spin-down-icon,
.dx-treelist .dx-editor-cell .dx-dropdowneditor-icon,
.dx-treelist .dx-editor-cell .dx-lookup-field::before {
  opacity: 0.4;
}
...
.dx-rtl.dx-treelist-headers .dx-dropdowneditor-button-visible.dx-show-clear-button .dx-texteditor-input,
.dx-rtl.dx-treelist-rowsview .dx-dropdowneditor-button-visible.dx-show-clear-button .dx-texteditor-input,
.dx-rtl .dx-treelist-headers .dx-dropdowneditor-button-visible.dx-show-clear-button .dx-texteditor-input,
.dx-rtl .dx-treelist-rowsview .dx-dropdowneditor-button-visible.dx-show-clear-button .dx-texteditor-input {
  padding-right: 10px;
  padding-left: 66px;
...
.dx-treelist-export-menu.dx-context-menu .dx-submenu > .dx-menu-items-container {
  background-color: #ffffff;
  border-color: #000000;
  color: #000000;
}
.dx-treelist-export-menu.dx-context-menu .dx-menu-separator {
  background-color: #000000;
}
...
.dx-treelist-column-chooser .dx-overlay-content .dx-popup-bottom .dx-toolbar-before {
  position: static;
  margin: 0 auto;
}
...
.dx-data-row.dx-state-hover:not(.dx-selection):not(.dx-row-inserted):not(.dx-row-removed):not(.dx-edit-row) > .dx-treelist-readonly:not(.dx-focused) .dx-texteditor .dx-texteditor-input {
  text-shadow: none;
  background-color: #404040;
  color: #fff;
}
...
.dx-treelist-header-panel .dx-toolbar-button:not(.dx-state-disabled) .dx-apply-:not(.dx-state-hover) .dx-button-content {
  background-color: #099f21;
}
...
.dx-treelist-rowsview .dx-editor-cell .dx-icon-clear {
  left: 0px;
}
...
.dx-treelist-rowsview .dx-adaptive-detail-row .dx-adaptive-item-text.dx-treelist-invalid {
  border: 2px solid #e81123;
  padding-top: 7px;
  padding-bottom: 7px;
  padding-left: 7px;
}
.dx-treelist-rowsview .dx-adaptive-detail-row .dx-item-modified {
  border: 2px solid #099f21;
}
.dx-treelist-rowsview .dx-adaptive-detail-row .dx-item-modified.dx-adaptive-item-text {
  padding-top: 7px;
  padding-bottom: 7px;
  padding-left: 7px;
}
...
.dx-treelist-rowsview .dx-selection .dx-focused {
  color: #fff;
}
.dx-treelist-rowsview .dx-selection.dx-row,
.dx-treelist-rowsview .dx-selection.dx-row:hover {
  text-shadow: none;
  color: #fff;
}
...
.dx-treelist-rowsview .dx-selection.dx-row > .dx-editor-inline-block,
.dx-treelist-rowsview .dx-selection.dx-row:hover > .dx-editor-inline-block {
  background-color: #115a93;
}
.dx-treelist-rowsview .dx-selection.dx-row > .dx-treelist-readonly .dx-texteditor .dx-texteditor-input,
.dx-treelist-rowsview .dx-selection.dx-row:hover > .dx-treelist-readonly .dx-texteditor .dx-texteditor-input {
  background-color: #115a93;
}
...
.dx-treelist-rowsview .dx-selection.dx-row > .dx-treelist-readonly:not(.dx-focused) .dx-texteditor .dx-texteditor-input,
.dx-treelist-rowsview .dx-selection.dx-row:hover > .dx-treelist-readonly:not(.dx-focused) .dx-texteditor .dx-texteditor-input {
  background-color: transparent;
}
.dx-treelist-rowsview .dx-selection.dx-row:not(.dx-row-lines),
...
.dx-treelist-revert-tooltip .dx-revert-button.dx-state-hover .dx-button-content {
  border-color: #e81123;
}
.dx-treelist-revert-tooltip .dx-revert-button.dx-state-focused .dx-button-content {
  background-color: rgba(232, 17, 35, 0.5);
}
...
.dx-rtl .dx-treelist-group-space {
  border-left: 1px solid transparent;
}
.dx-rtl .dx-editor-cell .dx-texteditor .dx-texteditor-input {
  padding-right: 7px;
...
.dx-rtl .dx-treelist-rowsview .dx-selection tr > td:not(.dx-focused).dx-treelist-group-space,
...
.dx-menu-base .dx-menu-item.dx-menu-item-has-icon .dx-menu-item-content {
  padding-left: 8px;
}
.dx-menu-base .dx-menu-item.dx-menu-item-has-submenu .dx-menu-item-content {
  padding-right: 36px;
}
...
.dx-menu-base .dx-menu-no-icons > .dx-menu-item-wrapper > .dx-menu-item > .dx-menu-item-content {
  padding-left: 8px;
}
...
.dx-menu-base .dx-menu-item-popout:before {
  content: "\f010";
}
.dx-menu-base .dx-menu-item-popout:before {
  display: block;
...
.dx-menu-base .dx-menu-separator {
  height: 1px;
  width: auto;
  margin: 3px 0;
  background-color: #999999;
}
.dx-menu-base.dx-rtl .dx-menu-item .dx-menu-item-content {
  padding-left: 8px;
  padding-right: 32px;
}
.dx-menu-base.dx-rtl .dx-menu-item.dx-menu-item-has-submenu .dx-menu-item-content {
  padding-left: 36px;
}
.dx-menu-base.dx-rtl .dx-menu-item.dx-menu-item-has-icon .dx-menu-item-content {
  padding-right: 8px;
}
.dx-menu-base.dx-rtl .dx-menu-item .dx-menu-item-content .dx-menu-item-popout-container {
  left: 0;
  right: auto;
  padding-left: 10px;
  padding-right: 0;
}
.dx-menu-base.dx-rtl .dx-menu-no-icons > .dx-menu-item-wrapper > .dx-menu-item > .dx-menu-item-content {
  padding-right: 8px;
}
.dx-menu-base.dx-rtl .dx-menu-item-has-text.dx-menu-item-has-icon .dx-icon {
  margin-left: 8px;
  margin-right: 0;
}
.dx-menu-base.dx-rtl .dx-menu-item-popout {
  font: 14px/1 DXIcons;
  width: 20px;
  height: 20px;
  background-position: 0px 0px;
...
.dx-menu-base.dx-rtl .dx-menu-item-popout:before {
  content: "\f012";
}
.dx-menu .dx-menu-horizontal .dx-menu-item .dx-menu-item-content {
  padding-left: 8px;
}
.dx-menu .dx-menu-horizontal .dx-menu-item-content .dx-menu-item-popout-container {
  width: 30px;
}
.dx-menu .dx-menu-horizontal .dx-menu-separator {
  height: 100%;
  width: 1px;
  margin: 0 3px;
}
...
.dx-menu.dx-rtl .dx-menu-horizontal .dx-menu-item .dx-menu-item-content {
  padding-right: 8px;
}
...
.dx-menu-adaptive-mode .dx-treeview .dx-state-focused > .dx-treeview-item,
.dx-menu-adaptive-mode .dx-treeview .dx-state-hover > .dx-treeview-item,
.dx-menu-adaptive-mode .dx-treeview .dx-state-active > .dx-treeview-item,
.dx-menu-adaptive-mode .dx-treeview .dx-state-focused.dx-treeview-item,
.dx-menu-adaptive-mode .dx-treeview .dx-state-hover.dx-treeview-item,
.dx-menu-adaptive-mode .dx-treeview .dx-state-active.dx-treeview-item {
  color: inherit;
...
.dx-calendar-navigator .dx-button-content {
  background: none;
  border: none;
}
...
.dx-calendar-navigator .dx-button .dx-button-content {
  padding-right: 0;
  padding-left: 0;
}
...
.dx-calendar-navigator .dx-button.dx-state-active .dx-button-content {
  background: none;
}
...
.dx-rtl.dx-calendar-caption-button,
.dx-rtl .dx-calendar-caption-button {
  right: 0;
  left: auto;
}
...
.dx-rtl.dx-calendar-navigator-next-view,
.dx-rtl .dx-calendar-navigator-next-view {
  right: auto;
  left: 0;
}
...
.dx-calendar-navigator-next-view .dx-icon:before {
  content: "\f016";
}
...
.dx-rtl.dx-calendar-navigator-previous-view,
.dx-rtl .dx-calendar-navigator-previous-view {
  right: auto;
  left: 40px;
}
...
.dx-calendar-navigator-previous-view .dx-icon:before {
  content: "\f014";
}
.dx-calendar-body {
  top: 40px;
...
.dx-calendar-with-footer .dx-calendar-body {
  bottom: 40px;
}
.dx-calendar-body .dx-calendar-empty-cell {
  cursor: default;
}
.dx-calendar-cell {
  text-align: center;
...
.dx-calendar-selected-date.dx-calendar-contoured-date,
.dx-calendar-selected-date.dx-state-active {
  border-color: #4ba0e3;
  border-style: solid;
  color: #fff;
}
.dx-calendar-selected-date.dx-state-hover,
.dx-calendar-selected-date.dx-calendar-contoured-date.dx-state-hover,
.dx-calendar-selected-date.dx-state-active.dx-state-hover,
.dx-calendar-selected-date.dx-calendar-contoured-date,
.dx-calendar-selected-date.dx-calendar-contoured-date.dx-calendar-contoured-date,
.dx-calendar-selected-date.dx-state-active.dx-calendar-contoured-date {
  border-color: #0078d7;
}
.dx-calendar-selected-date.dx-calendar-today,
.dx-calendar-selected-date.dx-calendar-contoured-date.dx-calendar-today,
.dx-calendar-selected-date.dx-state-active.dx-calendar-today {
  background-color: #0078d7;
}
.dx-calendar-empty-cell {
  background: url(data:image/png;base64,) center center no-repeat;
  background-size: 70% 70%;
  color: #666666;
}
.dx-calendar-empty-cell.dx-state-hover,
.dx-calendar-empty-cell.dx-state-active {
  border-color: transparent;
}
.dx-calendar-today {
  border-color: #0078d7;
...
.dx-calendar-today.dx-calendar-selected-date {
  outline: 2px solid #000000;
  outline-offset: -4px;
}
.dx-calendar-today.dx-state-hover,
...
.dx-calendar-footer .dx-calendar-today-button {
  color: #fff;
  text-decoration: none;
}
.dx-state-disabled .dx-calendar .dx-calendar-navigator .dx-button-content,
.dx-state-disabled.dx-calendar .dx-calendar-navigator .dx-button-content {
  background: none;
  color: #404040;
}
.dx-state-disabled .dx-calendar th,
.dx-state-disabled.dx-calendar th,
.dx-state-disabled .dx-calendar .dx-calendar-cell,
.dx-state-disabled.dx-calendar .dx-calendar-cell {
  color: #404040;
}
.dx-state-disabled .dx-calendar .dx-calendar-selected-date,
.dx-state-disabled.dx-calendar .dx-calendar-selected-date {
  border-color: #404040;
}
.dx-state-disabled .dx-calendar .dx-calendar-today,
.dx-state-disabled.dx-calendar .dx-calendar-today {
  color: #000000;
  border-color: #404040;
  background-color: #404040;
...
.dx-field-value > .dx-widget.dx-switch,
.dx-field-value.dx-widget.dx-checkbox,
.dx-field-value > .dx-widget.dx-checkbox,
.dx-field-value.dx-widget.dx-button,
.dx-field-value > .dx-widget.dx-button,
.dx-field-value.dx-widget.dx-radiogroup,
.dx-field-value > .dx-widget.dx-radiogroup {
  display: inline-block;
  width: auto;
}
...
.dx-field-value.dx-attention:before {
  ...
  width: 15px;
  height: 12px;
  background: url(data:image/png;base64,);
}
...
.dx-empty-collection.dx-tabpanel .dx-multiview-wrapper {
  border-top: none;
}
.dx-fileuploader {
  position: relative;
...
.dx-fileuploader .dx-button-has-icon .dx-button-content {
  padding-left: 0;
  padding-right: 0;
}
...
.dx-fileuploader-files-container .dx-fileuploader-button .dx-icon {
  width: 100%;
  height: 100%;
  font-size: 18px;
  padding: 0;
}
.dx-fileuploader-files-container .dx-fileuploader-button .dx-icon:before {
  position: relative;
  top: -2px;
}
...
.dx-timeview .dx-numberbox {
  width: 80px;
  margin: 4px 0;
}
.dx-timeview .dx-numberbox .dx-texteditor-container {
  margin: 0;
}
...
.dx-timeview-clock {
  background: url(data:image/png;base64,) no-repeat 50% 50%;
}
.dx-state-disabled .dx-timeview-clock {
  opacity: 0.4;
}
.dx-timeview-hourarrow {
  background-image: url(data:image/png;base64,iVBORw0KGgoAAAANSUhEUgAAAAUAAAA0CAQAAADoQDpmAAAAIklEQVQoz2P4L/x/0//3QCzM8H/xfwhYzPAfDkaZo0wcTAC0bQLdmbK79gAAAABJRU5ErkJggg==);
}
.dx-timeview-minutearrow {
  background-image: url(data:image/png;base64,iVBORw0KGgoAAAANSUhEUgAAAAQAAABcCAQAAADjJdxvAAAAIElEQVQ4y2P47/n/GRB6MgAJEHjG8B8KRhmjjFEGHgYAEDLbb/DaUH0AAAAASUVORK5CYII=);
}
.dx-timeview-field .dx-box-item {
  line-height: 16px;
}
.dx-timeview-field .dx-box-item:first-child .dx-numberbox {
  margin-right: 3px;
}
.dx-timeview-field .dx-box-item:last-child .dx-numberbox {
  margin-left: 3px;
}
.dx-timeview-field.dx-rtl .dx-box-item:first-child .dx-numberbox {
  margin-left: 3px;
  margin-right: 0;
}
.dx-timeview-field.dx-rtl .dx-box-item:last-child .dx-numberbox {
  margin-left: 0;
  margin-right: 3px;
}
...
.dx-scheduler-work-space-month.dx-scheduler-work-space-count .dx-scheduler-date-table-first-of-month {
  color: #115a93;
  background-color: rgba(17, 90, 147, 0.15);
  font-weight: bold;
}
...
.dx-scheduler-date-table-cell.dx-scheduler-focused-cell {
  -webkit-box-shadow: inset 0 0 0 1px #115a93;
          box-shadow: inset 0 0 0 1px #115a93;
}
...
.dx-scheduler-appointment.dx-resizable-resizing {
  -webkit-box-shadow: inset 0px -2px 0px 0px rgba(0, 0, 0, 0.5), inset 0px 2px 0px 0px rgba(0, 0, 0, 0.5);
          box-shadow: inset 0px -2px 0px 0px rgba(0, 0, 0, 0.5), inset 0px 2px 0px 0px rgba(0, 0, 0, 0.5);
}
...
.dx-scheduler-appointment.dx-state-hover {
  -webkit-box-shadow: inset 0px 5px 0px 0px rgba(0, 0, 0, 0.5);
          box-shadow: inset 0px 5px 0px 0px rgba(0, 0, 0, 0.5);
}
.dx-scheduler-appointment.dx-state-hover.dx-resizable {
  -webkit-box-shadow: inset 0px 5px 0px 0px rgba(0, 0, 0, 0.5), inset 0px -2px 0px 0px rgba(0, 0, 0, 0.5);
          box-shadow: inset 0px 5px 0px 0px rgba(0, 0, 0, 0.5), inset 0px -2px 0px 0px rgba(0, 0, 0, 0.5);
}
...
.dx-scheduler-appointment.dx-draggable-dragging {
  -webkit-box-shadow: 7px 7px 15px 0px rgba(50, 50, 50, 0.2), inset 0px -2px 0px 0px rgba(0, 0, 0, 0.5), inset 0px 2px 0px 0px rgba(0, 0, 0, 0.5);
          box-shadow: 7px 7px 15px 0px rgba(50, 50, 50, 0.2), inset 0px -2px 0px 0px rgba(0, 0, 0, 0.5), inset 0px 2px 0px 0px rgba(0, 0, 0, 0.5);
}
.dx-scheduler-appointment.dx-resizable-resizing,
.dx-scheduler-appointment.dx-draggable-dragging {
  z-index: 1000;
...
.dx-scheduler-all-day-appointment {
  -webkit-box-shadow: inset 2px 0px 0px 0px rgba(0, 0, 0, 0.5);
          box-shadow: inset 2px 0px 0px 0px rgba(0, 0, 0, 0.5);
}
...
.dx-scheduler-all-day-appointment.dx-resizable-resizing {
  -webkit-box-shadow: inset -2px 0px 0px 0px rgba(0, 0, 0, 0.5), inset 2px 0px 0px 0px rgba(0, 0, 0, 0.5);
          box-shadow: inset -2px 0px 0px 0px rgba(0, 0, 0, 0.5), inset 2px 0px 0px 0px rgba(0, 0, 0, 0.5);
}
...
.dx-scheduler-all-day-appointment.dx-state-hover {
  -webkit-box-shadow: inset 5px 0px 0px 0px rgba(0, 0, 0, 0.5);
          box-shadow: inset 5px 0px 0px 0px rgba(0, 0, 0, 0.5);
}
.dx-scheduler-timeline .dx-scheduler-appointment.dx-state-hover.dx-resizable,
.dx-scheduler-work-space-month .dx-scheduler-appointment.dx-state-hover.dx-resizable,
.dx-scheduler-all-day-appointment.dx-state-hover.dx-resizable {
  -webkit-box-shadow: inset 5px 0px 0px 0px rgba(0, 0, 0, 0.5), inset -2px 0px 0px 0px rgba(0, 0, 0, 0.5);
          box-shadow: inset 5px 0px 0px 0px rgba(0, 0, 0, 0.5), inset -2px 0px 0px 0px rgba(0, 0, 0, 0.5);
}
...
.dx-scheduler-all-day-appointment.dx-draggable-dragging {
  -webkit-box-shadow: inset -2px 0px 0px 0px rgba(0, 0, 0, 0.5), inset 2px 0px 0px 0px rgba(0, 0, 0, 0.5), 7px 7px 15px 0px rgba(50, 50, 50, 0.2);
          box-shadow: inset -2px 0px 0px 0px rgba(0, 0, 0, 0.5), inset 2px 0px 0px 0px rgba(0, 0, 0, 0.5), 7px 7px 15px 0px rgba(50, 50, 50, 0.2);
}
...
.dx-scheduler-appointment-tooltip .dx-button .dx-icon {
  width: 16px;
  height: 16px;
  font-size: 12px;
  line-height: 16px;
