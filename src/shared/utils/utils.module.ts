...
import { MinuteSecondsPipe } from '../common/pipes/minute-seconds.pipe';
import { TimerCountdownPipe } from '../common/pipes/timer-countdown.pipe';
...
@NgModule({
    ...
    declarations: [
        ...
        PermissionAllPipe, FileSizePipe, FormatTimePipe, MinuteSecondsPipe, TimerCountdownPipe
    ],
    exports: [
        EqualValidator,
        PasswordComplexityValidator,
