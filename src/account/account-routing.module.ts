        ...
        RouterModule.forChild([
            {
                ...
                children: [
                    ...
                    {
                        path: "app-entity-register",
                        component: EntityRegisterComponent /*canActivate: [AccountRouteGuard]*/
                    },
                    {
                        path: "app-external-audit-register",
                        component: ExternalAuditRegisterComponent /*canActivate: [AccountRouteGuard]*/
                    },
                    {

                        path: 'auditprojectAccept', component: AuditProjectAcceptComponent
                    ...
                    { path: 'pre-registration-verification', component: PreRegisterComponent },
                    { path: 'feedback-entity-response', component: FeedbackEntityResponseComponent },
                    { path: 'tte-entity-response', component: TTEEntityResponseComponent },
                    { path: 'entity-certificate', component: EntityCertitificationComponent },
                    { path: '**', redirectTo: 'login' }
                ]
            }
        ])
