...
import {
    BusinessEntitiesServiceProxy, ADControlrequirementCountDto, HealthCareLandingServiceProxy, GetBusinessEntitiesExcelDto, UserOriginType, EntityType, AuditDashboardServiceProxy, IncidentExceptionFindingDto, AssementTypeCountDto, BusinessEntitysListDto, HealthcarelandingDto, IdNameDto, DashboardDOmainGraphDto, AssessmentServiceProxy
...
@Component({
  selector: 'widget-total-risk-statistics',
  templateUrl: './widget-total-risk-statistics.component.html',
  styleUrls: ['./widget-total-risk-statistics.component.css']
})
export class WidgetTotalRiskStatisticsComponent extends WidgetComponentBase implements OnInit {
