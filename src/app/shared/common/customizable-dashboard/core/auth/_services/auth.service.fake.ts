...
export class AuthService {
    ...
    postlogin(email: string, password: string): Observable<User> {
        ...
        return this.http.post<User>(API_USERS_DYNAMIC_URL + "login", {
            email,
            password
        });
    }
    ...
    getaccounttype() {
        return this.http.get(API_USERS_DYNAMIC_URL + "getaccounttype");
    }
    ...
    getuserlist() {
        ...
        return this.http.get(API_USERS_DYNAMIC_URL + "getuserlist", {
            headers: httpheader
        });
    }
}
