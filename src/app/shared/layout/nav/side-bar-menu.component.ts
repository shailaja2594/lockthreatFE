...
import { Injector, ElementRef, Component, OnInit, ViewEncapsulation, Inject, Renderer2, AfterViewInit, Output, EventEmitter } from '@angular/core';
...
export class SideBarMenuComponent extends AppComponentBase implements OnInit, AfterViewInit {
    ...
    ngOnInit() {
        ...
        let urlPart = a[a.length - 1];
        this.menuEvent.emit(urlPart);
    ...
    clickMenu(e) {      
        //if (e == 'HealthCare Entities') {
        //    this.router.navigate(['/app/main/health-care-entities-landing-page']);
        //}
        //else if (e == 'Compliance Management') {
        //    this.router.navigate(['/app/main/compliance-management-landing-page']);
        //}
        //else if (e == 'Audit Management') {
        //    this.router.navigate(['/app/main/audit-management-landing-page']);
        //}
        //else if (e == 'Organization Setup') {
        //    this.router.navigate(['/app/main/organization-setup-landing-page']);
        //}
    }
