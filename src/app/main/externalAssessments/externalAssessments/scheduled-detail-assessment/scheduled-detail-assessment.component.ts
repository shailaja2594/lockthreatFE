...
@Component({
    templateUrl: './scheduled-detail-assessment.component.html',
    encapsulation: ViewEncapsulation.None,
    animations: [appModuleAnimation()],
    selector: 'scheduled-detail-assessment',
})
export class ScheduledDetailSssessmentComponent extends AppComponentBase implements OnInit {
