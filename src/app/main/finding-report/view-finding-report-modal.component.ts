...
@Component({
    selector: 'viewFindingReportModals',
    templateUrl: './view-finding-report-modal.component.html'
})
export class ViewFindingReportModalComponent extends AppComponentBase {

    @ViewChild('viewFindingReportModal', { static: true }) modal: ModalDirective;
