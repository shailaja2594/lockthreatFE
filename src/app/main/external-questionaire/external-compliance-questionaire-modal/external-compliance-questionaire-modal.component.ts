...
@Component({
    selector: "externalComplianceQuestionaireModals",
    templateUrl: "./external-compliance-questionaire-modal.component.html",
    styleUrls: ["./external-compliance-questionaire-modal.component.css"],
})
export class ExternalComplianceQuestionaireModalComponent extends AppComponentBase implements OnInit {


    @ViewChild('externalComplianceQuestionaireModal', { static: true }) modal: ModalDirective;
    active = false;
    saving = false;
    editMode: any;
    assessmentId: any;
