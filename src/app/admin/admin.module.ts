...
import { ModalModule, PopoverModule, TabsModule,  BsDropdownModule } from 'ngx-bootstrap';
...
//AgreenmentAcceptance
import { AgreenmentAcceptanceLogComponent } from "./agreenment-acceptance-log/agreenment-acceptance-log.component";
// BusinessTypes
import { BusinessTypesComponent } from "./businessTypes/businessTypes/businessTypes.component";
import { ViewBusinessTypeModalComponent } from "./businessTypes/businessTypes/view-businessType-modal.component";
import { CreateOrEditBusinessTypeModalComponent } from "./businessTypes/businessTypes/create-or-edit-businessType-modal.component";
//EntityGroup
import { EntityGroupsComponent } from './entityGroups/entityGroups/entityGroups.component';
import { ViewEntityGroupModalComponent } from './entityGroups/entityGroups/view-entityGroup-modal.component';
import { CreateOrEditEntityGroupModalComponent } from './entityGroups/entityGroups/create-or-edit-entityGroup-modal.component';
//Exception
...
//FacilityTypes
import { FacilityTypesComponent } from "./facilityTypes/facilityTypes/facilityTypes.component";
import { ViewFacilityTypeModalComponent } from "./facilityTypes/facilityTypes/view-facilityType-modal.component";
import { CreateOrEditFacilityTypeModalComponent } from "./facilityTypes/facilityTypes/create-or-edit-facilityType-modal.component";
import { AccordionModule } from 'primeng/accordion';
import { GridAuditProjectWorkFlowComponent } from './workflow/audit-project-work-flow/grid-audit-project-work-flow.component';
import { AuditProjectWorkFlowModalComponent } from './workflow/audit-project-work-flow/audit-project-work-flow-modal/audit-project-work-flow-modal.component';
import { MultiSelectModule } from 'primeng/multiselect';
import { Work_FlowComponent } from './work-flow/work-flow.component';
import { NgSelectModule } from "@ng-select/ng-select";
import { AfterModalComponent } from './work-flow/after-modal/after-modal.component';
import { BeforeModalComponent } from './work-flow/before-modal/before-modal.component';
import { EscalationModalComponent } from './work-flow/escalation-modal/escalation-modal.component';
import { OnDayModalComponent } from './work-flow/on-day-modal/on-day-modal.component';
import { SubEntityGroupsComponent } from './sub-entity-groups/sub-entity-groups.component';
import { CreateEditSubEntityGroupModalComponent } from './sub-entity-groups/create-edit-sub-entity-group-modal/create-edit-sub-entity-group-modal.component';
import { CreateOrEditFacilitysubTypeModalComponent } from './facilitySubtypes/create-or-edit-facilitySubType-modal.component';
import { FacilitySubTypesComponent } from './facilitySubtypes/facilitySubTypes.component';
import { GridWorkFlowComponent } from './work-flow/grid-work-flow.component';
...
@NgModule({
    imports: [
        ...
        PickListModule,
        AccordionModule,
        MultiSelectModule, NgSelectModule, CalendarModule, DxReportViewerModule
    ],
    declarations: [
        UsersComponent,
        ...
        WorkflowComponent,
        GridWorkFlowComponent,
        AgreenmentAcceptanceLogComponent,
        BusinessTypesComponent,
        ViewBusinessTypeModalComponent,
        CreateOrEditBusinessTypeModalComponent,
        EntityGroupsComponent,
        ViewEntityGroupModalComponent, CreateOrEditEntityGroupModalComponent,
        ExceptionTypesComponent,
        CreateOrEditExceptionTypeModalComponent,
        ViewFacilityTypeModalComponent,
        CreateOrEditFacilityTypeModalComponent,
        FacilityTypesComponent,
        GridAuditProjectWorkFlowComponent,
        AuditProjectWorkFlowModalComponent, Work_FlowComponent,
        AfterModalComponent, BeforeModalComponent, EscalationModalComponent, OnDayModalComponent,
        SubEntityGroupsComponent, CreateEditSubEntityGroupModalComponent,
        FacilitySubTypesComponent, CreateOrEditFacilitysubTypeModalComponent
