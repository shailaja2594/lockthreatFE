...
export class AuditLogsComponent extends AppComponentBase implements AfterViewInit {
    ...
    exportChangesButtonHide: boolean;
    exportOperationalButtonHide: boolean;
    constructor(
        injector: Injector,
    ...
    exportChangesHide() {
        if (this.primengTableHelperEntityChanges.totalRecordsCount == 0) {
            this.exportChangesButtonHide = false;
        }
        else {
            this.exportChangesButtonHide = true;
        }
    }

    exportOperationalHide() {
        if (this.primengTableHelperAuditLogs.totalRecordsCount == 0) {
            this.exportOperationalButtonHide = false;
        }
        else {
            this.exportOperationalButtonHide = true;
        }
    }
}
