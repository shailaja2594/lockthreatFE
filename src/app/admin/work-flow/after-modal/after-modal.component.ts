...
@Component({
    selector: 'afterModals',
    templateUrl: './after-modal.component.html',
    styleUrls: ['./after-modal.component.css']
})
export class AfterModalComponent extends AppComponentBase implements OnInit {
    ...
    @ViewChild('afterModal', { static: true }) modal: ModalDirective;
    @Output() modalSave: EventEmitter<any> = new EventEmitter<any>();

    constructor(_injector: Injector,      
        private _activatedRoute: ActivatedRoute,
        private _router: Router, private _workFlowServiceProxy: WorkFlowServiceProxy
    ...
    show(stateId: number, actionId: number) {        
        if (stateId != undefined && stateId != 0) {
            if (actionId != 0) {
                ...
                this.createAction.actionCategory = ActionCategory.After;
