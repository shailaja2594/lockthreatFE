        ...
        RouterModule.forChild([
            {
                ...
                children: [
                    ...
                    { path: "entityGroups/entityGroups", component: EntityGroupsComponent, data: { permission: "Pages.Administration.EntityGroups" } },
                    {
                        path: "businessTypes/businessTypes",
                        component: BusinessTypesComponent,
                        data: {
                            permission: "Pages.SystemSetUp.BusinessTypes"
                        }
                    },
                    {
                        path: "exceptionTypes/exceptionTypes",
                        component: ExceptionTypesComponent,
                        data: { permission: "Pages.SystemSetUp.Exceptions.ExceptionTypes" }
                    },
                    {
                        path: "facilityTypes/facilityTypes",
                        component: FacilityTypesComponent,
                        data: {
                            permission: "Pages.SystemSetUp.FacilityTypes"
                        }
                    },
                    {
                        path: "facilitysubTypes",
                        component: FacilitySubTypesComponent,
                        data: {
                            permission: "Pages.SystemSetUp.FacilityTypes"
                        }
                    },
                    ...
                    },
                    {
                        ...
                        data: { permission: "Pages.Administration.ApplicationSettings" }
                    },
                    {
                        path: "grid-work-flows",
                        component: GridWorkFlowComponent,
                        data: { permission: "Pages.Administration.ApplicationSettings" }
                    },
                    
                    {
                        path: "agreement-acceptance-logs",
                        component: AgreenmentAcceptanceLogComponent
                    },
                    ...
                    { path: 'work-flow', component: Work_FlowComponent },
                    { path: 'sub-entity-groups', component: SubEntityGroupsComponent },                  
