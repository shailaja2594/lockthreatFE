...
export class OrganizationUnitsTreeComponent extends AppComponentBase {
    ...
    set data(data: IOrganizationUnitsTreeComponentData) {
        ...
        this.filterData = data.allOrganizationUnits;
        this.selectedOrganizationUnitId = data.selectedOrganizationUnitId;
    ...
    setSelectedNodes(selectedOrganizationUnits: string[]) {
        ...
        let item = this._treeDataHelperService.findNode(this.treeData, { data: { id: this.selectedOrganizationUnitId } });
        if (item) {
